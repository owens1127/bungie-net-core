...
export const getForumTagSuggestionsTests: TestCase<typeof getForumTagSuggestions>[] = [];
...
>[] = [];
export const getPostsThreadedPagedTests: TestCase<typeof getPostsThreadedPaged>[] = [];
export const getPostsThreadedPagedFromChildTests: TestCase<
  typeof getPostsThreadedPagedFromChild
>[] = [];
export const getRecruitmentThreadSummariesTests: TestCase<typeof getRecruitmentThreadSummaries>[] =
  [];
