...
export const addOptionalConversationTests: TestCase<typeof addOptionalConversation>[] = [];
...
export const approvePendingForListTests: TestCase<typeof approvePendingForList>[] = [];
...
export const editOptionalConversationTests: TestCase<typeof editOptionalConversation>[] = [];
export const getAdminsAndFounderOfGroupTests: TestCase<typeof getAdminsAndFounderOfGroup>[] = [];
...
export const getBannedMembersOfGroupTests: TestCase<typeof getBannedMembersOfGroup>[] = [];
...
export const getGroupOptionalConversationsTests: TestCase<typeof getGroupOptionalConversations>[] =
  [];
export const getGroupsForMemberTests: TestCase<typeof getGroupsForMember>[] = [];
export const getInvitedIndividualsTests: TestCase<typeof getInvitedIndividuals>[] = [];
export const getMembersOfGroupTests: TestCase<typeof getMembersOfGroup>[] = [];
export const getPendingMembershipsTests: TestCase<typeof getPendingMemberships>[] = [];
export const getPotentialGroupsForMemberTests: TestCase<typeof getPotentialGroupsForMember>[] = [];
export const getRecommendedGroupsTests: TestCase<typeof getRecommendedGroups>[] = [];
export const getUserClanInviteSettingTests: TestCase<typeof getUserClanInviteSetting>[] = [];
export const groupSearchTests: TestCase<typeof groupSearch>[] = [];
export const individualGroupInviteTests: TestCase<typeof individualGroupInvite>[] = [];
export const individualGroupInviteCancelTests: TestCase<typeof individualGroupInviteCancel>[] = [];
export const kickMemberTests: TestCase<typeof kickMember>[] = [];
export const recoverGroupForFounderTests: TestCase<typeof recoverGroupForFounder>[] = [];
