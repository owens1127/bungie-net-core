...
exports.getDestinyManifestSlice = void 0;
var _1 = require("./");
/**
 ...
 */
function getDestinyManifestSlice(params) {
    return __awaiter(this, void 0, void 0, function () {
        var downloadedTables, manifestSlice, _i, downloadedTables_1, downloadedTable;
        var _this = this;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, Promise.all(params.tableNames.map(function (tableName) { return __awaiter(_this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, (0, _1.getDestinyManifestComponent)({
                ...
                case 1:
                    ...
                    manifestSlice = {};
                    for (_i = 0, downloadedTables_1 = downloadedTables; _i < downloadedTables_1.length; _i++) {
                        downloadedTable = downloadedTables_1[_i];
                        manifestSlice[downloadedTable.tableName] = downloadedTable.tableContent;
                    }
                    return [2 /*return*/, manifestSlice];
            }
        });
    });
}
