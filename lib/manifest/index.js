 ...
 * @property {{[key: number | string]: import('../schemas/Destiny/Definitions/DestinyProgressionDefinition.js')}} DestinyProgressionDefinitions
 * @property {{[key: number | string]: import('../schemas/Destiny/Definitions/DestinyInventoryItemDefinition.js')}} DestinyInventoryItemDefinitions
 * @property {{[key: number | string]: import('../schemas/Destiny/Definitions/Collectibles/DestinyCollectibleDefinition.js')}} DestinyCollectibleDefinitions
 * @property {{[key: number | string]: import('../schemas/Destiny/Definitions/DestinyMaterialRequirementSetDefinition.js')}} DestinyMaterialRequirementSetDefinitions
 * @property {{[key: number | string]: import('../schemas/Destiny/Definitions/Presentation/DestinyPresentationNodeDefinition.js')}} DestinyPresentationNodeDefinitions
 * @property {{[key: number | string]: import('../schemas/Destiny/Definitions/DestinyObjectiveDefinition.js')}} DestinyObjectiveDefinitions
 * @property {{[key: number | string]: import('../schemas/Destiny/Definitions/DestinyLocationDefinition.js')}} DestinyLocationDefinitions
 * @property {{[key: number | string]: import('../schemas/Destiny/Definitions/DestinyVendorDefinition.js')}} DestinyVendorDefinitions
 * @property {{[key: number | string]: import('../schemas/Destiny/Definitions/DestinyFactionDefinition.js')}} DestinyFactionDefinitions
 * @property {{[key: number | string]: import('../schemas/Destiny/Definitions/DestinyDestinationDefinition.js')}} DestinyDestinationDefinitions
 * @property {{[key: number | string]: import('../schemas/Destiny/Definitions/DestinyPlaceDefinition.js')}} DestinyPlaceDefinitions
 * @property {{[key: number | string]: import('../schemas/Destiny/Definitions/DestinyActivityDefinition.js')}} DestinyActivityDefinitions
 * @property {{[key: number | string]: import('../schemas/Destiny/Definitions/DestinyActivityTypeDefinition.js')}} DestinyActivityTypeDefinitions
 * @property {{[key: number | string]: import('../schemas/Destiny/Definitions/ActivityModifiers/DestinyActivityModifierDefinition.js')}} DestinyActivityModifierDefinitions
 * @property {{[key: number | string]: import('../schemas/Destiny/Definitions/DestinyActivityModeDefinition.js')}} DestinyActivityModeDefinitions
 * @property {{[key: number | string]: import('../schemas/Destiny/Definitions/Director/DestinyActivityGraphDefinition.js')}} DestinyActivityGraphDefinitions
 * @property {{[key: number | string]: import('../schemas/Destiny/Definitions/DestinyEquipmentSlotDefinition.js')}} DestinyEquipmentSlotDefinitions
 * @property {{[key: number | string]: import('../schemas/Destiny/Definitions/DestinyInventoryBucketDefinition.js')}} DestinyInventoryBucketDefinitions
 * @property {{[key: number | string]: import('../schemas/Destiny/Definitions/Sockets/DestinySocketTypeDefinition.js')}} DestinySocketTypeDefinitions
 * @property {{[key: number | string]: import('../schemas/Destiny/Definitions/Sockets/DestinySocketCategoryDefinition.js')}} DestinySocketCategoryDefinitions
 * @property {{[key: number | string]: import('../schemas/Destiny/Definitions/DestinyVendorGroupDefinition.js')}} DestinyVendorGroupDefinitions
 * @property {{[key: number | string]: import('../schemas/Destiny/Definitions/DestinySandboxPerkDefinition.js')}} DestinySandboxPerkDefinitions
 * @property {{[key: number | string]: import('../schemas/Destiny/Definitions/DestinyDamageTypeDefinition.js')}} DestinyDamageTypeDefinitions
 * @property {{[key: number | string]: import('../schemas/Destiny/Definitions/DestinyStatDefinition.js')}} DestinyStatDefinitions
 * @property {{[key: number | string]: import('../schemas/Destiny/Definitions/Records/DestinyRecordDefinition.js')}} DestinyRecordDefinitions
 * @property {{[key: number | string]: import('../schemas/Destiny/Definitions/Lore/DestinyLoreDefinition.js')}} DestinyLoreDefinitions
 * @property {{[key: number | string]: import('../schemas/Destiny/Definitions/DestinyGenderDefinition.js')}} DestinyGenderDefinitions
 * @property {{[key: number | string]: import('../schemas/Destiny/Definitions/Traits/DestinyTraitDefinition.js')}} DestinyTraitDefinitions
 * @property {{[key: number | string]: import('../schemas/Destiny/Definitions/Traits/DestinyTraitCategoryDefinition.js')}} DestinyTraitCategoryDefinitions
 * @property {{[key: number | string]: import('../schemas/Destiny/Definitions/Metrics/DestinyMetricDefinition.js')}} DestinyMetricDefinitions
 * @property {{[key: number | string]: import('../schemas/Destiny/Definitions/Items/DestinyItemTierTypeDefinition.js')}} DestinyItemTierTypeDefinitions
 * @property {{[key: number | string]: import('../schemas/Destiny/Definitions/DestinyStatGroupDefinition.js')}} DestinyStatGroupDefinitions
 * @property {{[key: number | string]: import('../schemas/Destiny/Definitions/DestinySandboxPatternDefinition.js')}} DestinySandboxPatternDefinitions
 * @property {{[key: number | string]: import('../schemas/Destiny/Definitions/DestinyClassDefinition.js')}} DestinyClassDefinitions
 * @property {{[key: number | string]: import('../schemas/Destiny/Definitions/Artifacts/DestinyArtifactDefinition.js')}} DestinyArtifactDefinitions
 * @property {{[key: number | string]: import('../schemas/Destiny/Definitions/Progression/DestinyProgressionLevelRequirementDefinition.js')}} DestinyProgressionLevelRequirementDefinitions
 * @property {{[key: number | string]: import('../schemas/Destiny/Definitions/PowerCaps/DestinyPowerCapDefinition.js')}} DestinyPowerCapDefinitions
 * @property {{[key: number | string]: import('../schemas/Destiny/Definitions/DestinyRewardSourceDefinition.js')}} DestinyRewardSourceDefinitions
 * @property {{[key: number | string]: import('../schemas/Destiny/Definitions/EnergyTypes/DestinyEnergyTypeDefinition.js')}} DestinyEnergyTypeDefinitions
 * @property {{[key: number | string]: import('../schemas/Destiny/Definitions/Sockets/DestinyPlugSetDefinition.js')}} DestinyPlugSetDefinitions
 * @property {{[key: number | string]: import('../schemas/Destiny/Definitions/DestinyTalentGridDefinition.js')}} DestinyTalentGridDefinitions
 * @property {{[key: number | string]: import('../schemas/Destiny/Definitions/DestinyItemCategoryDefinition.js')}} DestinyItemCategoryDefinitions
 * @property {{[key: number | string]: import('../schemas/Destiny/Definitions/BreakerTypes/DestinyBreakerTypeDefinition.js')}} DestinyBreakerTypeDefinitions
 * @property {{[key: number | string]: import('../schemas/Destiny/Definitions/Seasons/DestinySeasonDefinition.js')}} DestinySeasonDefinitions
 * @property {{[key: number | string]: import('../schemas/Destiny/Definitions/Seasons/DestinySeasonPassDefinition.js')}} DestinySeasonPassDefinitions
 * @property {{[key: number | string]: import('../schemas/Destiny/Definitions/Seasons/DestinyEventCardDefinition.js')}} DestinyEventCardDefinitions
 * @property {{[key: number | string]: import('../schemas/Destiny/Definitions/Checklists/DestinyChecklistDefinition.js')}} DestinyChecklistDefinitions
 * @property {{[key: number | string]: import('../schemas/Destiny/Definitions/DestinyRaceDefinition.js')}} DestinyRaceDefinitions
 * @property {{[key: number | string]: import('../schemas/Destiny/Definitions/Milestones/DestinyMilestoneDefinition.js')}} DestinyMilestoneDefinitions
 * @property {{[key: number | string]: import('../schemas/Destiny/Definitions/DestinyUnlockDefinition.js')}} DestinyUnlockDefinitions
 * @property {{[key: number | string]: import('../schemas/Destiny/Definitions/Reporting/DestinyReportReasonCategoryDefinition.js')}} DestinyReportReasonCategoryDefinitions
 * @property {{[key: number | string]: import('../schemas/Destiny/Definitions/DestinyMedalTierDefinition.js')}} DestinyMedalTierDefinitions
*/
...
exports.GetAllDestinyManifestComponents = require('./GetAllDestinyManifestComponents.js');
exports.GetDestinyManifestComponent = require('./GetDestinyManifestComponent.js');
exports.GetDestinyManifestSlice = require('./GetDestinyManifestSlice.js');