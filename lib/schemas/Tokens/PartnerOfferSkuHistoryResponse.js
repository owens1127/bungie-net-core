 ...
 * @property {string} SkuIdentifier 
 * @property {string} LocalizedName 
 * @property {string} LocalizedDescription 
 * @property {string} ClaimDate 
 * @property {boolean} AllOffersApplied 
 * @property {string} TransactionId 
 * @property {PartnerOfferHistoryResponse[]} SkuOffers 
...
module.exports = PartnerOfferSkuHistoryResponse;
