...
(function (TrendingEntryType) {
    ...
    TrendingEntryType[(TrendingEntryType['DestinyActivity'] = 2)] =
        'DestinyActivity';
    TrendingEntryType[(TrendingEntryType['DestinyRitual'] = 3)] =
        'DestinyRitual';
    TrendingEntryType[(TrendingEntryType['SupportArticle'] = 4)] =
        'SupportArticle';
