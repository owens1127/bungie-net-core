...
/**
 * @type {typeof SearchResultOfDestinyEntitySearchResultItem}
 * @see {@link https://bungie-net.github.io/#/components/schemas/SearchResultOfDestinyEntitySearchResultItem}
*/
module.exports = class SearchResultOfDestinyEntitySearchResultItem {
  /**
   * @readonly
   * @type import('./Destiny/Definitions/DestinyEntitySearchResultItem')[]
  */
  results;
  /**
   * @readonly
