...
(function (PlatformErrorCodes) {
    ...
    PlatformErrorCodes[(PlatformErrorCodes['TransportException'] = 2)] =
        'TransportException';
    PlatformErrorCodes[(PlatformErrorCodes['UnhandledException'] = 3)] =
        'UnhandledException';
    PlatformErrorCodes[(PlatformErrorCodes['NotImplemented'] = 4)] =
        'NotImplemented';
    PlatformErrorCodes[(PlatformErrorCodes['SystemDisabled'] = 5)] =
        'SystemDisabled';
    PlatformErrorCodes[
        (PlatformErrorCodes['FailedToLoadAvailableLocalesConfiguration'] = 6)
    ] = 'FailedToLoadAvailableLocalesConfiguration';
    PlatformErrorCodes[(PlatformErrorCodes['ParameterParseFailure'] = 7)] =
        'ParameterParseFailure';
    PlatformErrorCodes[(PlatformErrorCodes['ParameterInvalidRange'] = 8)] =
        'ParameterInvalidRange';
    PlatformErrorCodes[(PlatformErrorCodes['BadRequest'] = 9)] = 'BadRequest';
    PlatformErrorCodes[(PlatformErrorCodes['AuthenticationInvalid'] = 10)] =
        'AuthenticationInvalid';
    PlatformErrorCodes[(PlatformErrorCodes['DataNotFound'] = 11)] =
        'DataNotFound';
    PlatformErrorCodes[(PlatformErrorCodes['InsufficientPrivileges'] = 12)] =
        'InsufficientPrivileges';
    PlatformErrorCodes[(PlatformErrorCodes['Duplicate'] = 13)] = 'Duplicate';
    PlatformErrorCodes[(PlatformErrorCodes['UnknownSqlResult'] = 14)] =
        'UnknownSqlResult';
    PlatformErrorCodes[(PlatformErrorCodes['ValidationError'] = 15)] =
        'ValidationError';
    PlatformErrorCodes[
    ...
    PlatformErrorCodes[(PlatformErrorCodes['InvalidParameters'] = 18)] =
        'InvalidParameters';
    PlatformErrorCodes[(PlatformErrorCodes['ParameterNotFound'] = 19)] =
        'ParameterNotFound';
    PlatformErrorCodes[(PlatformErrorCodes['UnhandledHttpException'] = 20)] =
        'UnhandledHttpException';
    PlatformErrorCodes[(PlatformErrorCodes['NotFound'] = 21)] = 'NotFound';
    PlatformErrorCodes[(PlatformErrorCodes['WebAuthModuleAsyncFailed'] = 22)] =
        'WebAuthModuleAsyncFailed';
    PlatformErrorCodes[(PlatformErrorCodes['InvalidReturnValue'] = 23)] =
        'InvalidReturnValue';
    PlatformErrorCodes[(PlatformErrorCodes['UserBanned'] = 24)] = 'UserBanned';
    PlatformErrorCodes[(PlatformErrorCodes['InvalidPostBody'] = 25)] =
        'InvalidPostBody';
    PlatformErrorCodes[(PlatformErrorCodes['MissingPostBody'] = 26)] =
        'MissingPostBody';
    PlatformErrorCodes[(PlatformErrorCodes['ExternalServiceTimeout'] = 27)] =
        'ExternalServiceTimeout';
    PlatformErrorCodes[(PlatformErrorCodes['ValidationLengthError'] = 28)] =
        'ValidationLengthError';
    PlatformErrorCodes[(PlatformErrorCodes['ValidationRangeError'] = 29)] =
        'ValidationRangeError';
    PlatformErrorCodes[(PlatformErrorCodes['JsonDeserializationError'] = 30)] =
        'JsonDeserializationError';
    PlatformErrorCodes[(PlatformErrorCodes['ThrottleLimitExceeded'] = 31)] =
        'ThrottleLimitExceeded';
    PlatformErrorCodes[(PlatformErrorCodes['ValidationTagError'] = 32)] =
        'ValidationTagError';
    PlatformErrorCodes[(PlatformErrorCodes['ValidationProfanityError'] = 33)] =
        'ValidationProfanityError';
    PlatformErrorCodes[(PlatformErrorCodes['ValidationUrlFormatError'] = 34)] =
    ...
    PlatformErrorCodes[(PlatformErrorCodes['ExternalServiceUnknown'] = 38)] =
        'ExternalServiceUnknown';
    PlatformErrorCodes[(PlatformErrorCodes['ValidationWordLengthError'] = 39)] =
        'ValidationWordLengthError';
    PlatformErrorCodes[
        (PlatformErrorCodes['ValidationInvisibleUnicode'] = 40)
    ] = 'ValidationInvisibleUnicode';
    PlatformErrorCodes[(PlatformErrorCodes['ValidationBadNames'] = 41)] =
        'ValidationBadNames';
    PlatformErrorCodes[(PlatformErrorCodes['ExternalServiceFailed'] = 42)] =
        'ExternalServiceFailed';
    PlatformErrorCodes[(PlatformErrorCodes['ServiceRetired'] = 43)] =
        'ServiceRetired';
    PlatformErrorCodes[(PlatformErrorCodes['UnknownSqlException'] = 44)] =
        'UnknownSqlException';
    PlatformErrorCodes[(PlatformErrorCodes['UnsupportedLocale'] = 45)] =
        'UnsupportedLocale';
    PlatformErrorCodes[(PlatformErrorCodes['InvalidPageNumber'] = 46)] =
        'InvalidPageNumber';
    PlatformErrorCodes[(PlatformErrorCodes['MaximumPageSizeExceeded'] = 47)] =
        'MaximumPageSizeExceeded';
    PlatformErrorCodes[(PlatformErrorCodes['ServiceUnsupported'] = 48)] =
        'ServiceUnsupported';
    PlatformErrorCodes[
    ...
    PlatformErrorCodes[(PlatformErrorCodes['AuthContextCacheAssertion'] = 52)] =
    ...
    PlatformErrorCodes[(PlatformErrorCodes['PerUserThrottleExceeded'] = 57)] =
        'PerUserThrottleExceeded';
    PlatformErrorCodes[
        (PlatformErrorCodes['PayloadSignatureVerificationFailure'] = 58)
    ] = 'PayloadSignatureVerificationFailure';
    PlatformErrorCodes[(PlatformErrorCodes['InvalidServiceAuthContext'] = 59)] =
        'InvalidServiceAuthContext';
    PlatformErrorCodes[(PlatformErrorCodes['ObsoleteCredentialType'] = 89)] =
        'ObsoleteCredentialType';
    PlatformErrorCodes[(PlatformErrorCodes['UnableToUnPairMobileApp'] = 90)] =
        'UnableToUnPairMobileApp';
    PlatformErrorCodes[(PlatformErrorCodes['UnableToPairMobileApp'] = 91)] =
    ...
    PlatformErrorCodes[(PlatformErrorCodes['MissingDeviceCookie'] = 93)] =
        'MissingDeviceCookie';
    PlatformErrorCodes[(PlatformErrorCodes['FacebookTokenExpired'] = 94)] =
        'FacebookTokenExpired';
    PlatformErrorCodes[(PlatformErrorCodes['AuthTicketRequired'] = 95)] =
        'AuthTicketRequired';
    PlatformErrorCodes[(PlatformErrorCodes['CookieContextRequired'] = 96)] =
    ...
    PlatformErrorCodes[(PlatformErrorCodes['WebAuthRequired'] = 99)] =
        'WebAuthRequired';
    PlatformErrorCodes[(PlatformErrorCodes['ContentUnknownSqlResult'] = 100)] =
        'ContentUnknownSqlResult';
    PlatformErrorCodes[(PlatformErrorCodes['ContentNeedUniquePath'] = 101)] =
        'ContentNeedUniquePath';
    PlatformErrorCodes[(PlatformErrorCodes['ContentSqlException'] = 102)] =
        'ContentSqlException';
    PlatformErrorCodes[(PlatformErrorCodes['ContentNotFound'] = 103)] =
        'ContentNotFound';
    PlatformErrorCodes[
    ...
    PlatformErrorCodes[(PlatformErrorCodes['ContentInvalidId'] = 106)] =
        'ContentInvalidId';
    PlatformErrorCodes[
    ...
    PlatformErrorCodes[(PlatformErrorCodes['ContentUploadFailed'] = 112)] =
        'ContentUploadFailed';
    PlatformErrorCodes[(PlatformErrorCodes['ContentTooManyResults'] = 113)] =
        'ContentTooManyResults';
    PlatformErrorCodes[(PlatformErrorCodes['ContentInvalidState'] = 115)] =
        'ContentInvalidState';
    PlatformErrorCodes[
    ...
    PlatformErrorCodes[(PlatformErrorCodes['ContentValidationError'] = 119)] =
        'ContentValidationError';
    PlatformErrorCodes[
        (PlatformErrorCodes['ContentPropertiesValidationError'] = 120)
    ] = 'ContentPropertiesValidationError';
    PlatformErrorCodes[(PlatformErrorCodes['ContentTypeNotFound'] = 121)] =
        'ContentTypeNotFound';
    PlatformErrorCodes[
    ...
    PlatformErrorCodes[(PlatformErrorCodes['ContentProjectNotFound'] = 129)] =
        'ContentProjectNotFound';
    PlatformErrorCodes[(PlatformErrorCodes['ContentFolderNotFound'] = 130)] =
    ...
    PlatformErrorCodes[(PlatformErrorCodes['ContentLockedForChanges'] = 135)] =
        'ContentLockedForChanges';
    PlatformErrorCodes[(PlatformErrorCodes['ContentFileUploadFailed'] = 136)] =
        'ContentFileUploadFailed';
    PlatformErrorCodes[(PlatformErrorCodes['ContentNotReviewed'] = 137)] =
        'ContentNotReviewed';
    PlatformErrorCodes[(PlatformErrorCodes['ContentPermissionDenied'] = 138)] =
    ...
    PlatformErrorCodes[(PlatformErrorCodes['ContentTagSaveFailure'] = 141)] =
    ...
    PlatformErrorCodes[(PlatformErrorCodes['ContentPropertyRequired'] = 155)] =
        'ContentPropertyRequired';
    PlatformErrorCodes[(PlatformErrorCodes['ContentCannotCreateFile'] = 156)] =
    ...
    PlatformErrorCodes[(PlatformErrorCodes['ContentReviewDataChanged'] = 160)] =
    ...
    PlatformErrorCodes[(PlatformErrorCodes['ContentUnauthorized'] = 163)] =
        'ContentUnauthorized';
    PlatformErrorCodes[
        (PlatformErrorCodes['ContentCannotCreateDeploymentPackage'] = 164)
    ] = 'ContentCannotCreateDeploymentPackage';
    PlatformErrorCodes[(PlatformErrorCodes['ContentUserNotFound'] = 165)] =
        'ContentUserNotFound';
    PlatformErrorCodes[
    ...
    PlatformErrorCodes[(PlatformErrorCodes['ContentBabelCallFailed'] = 173)] =
    ...
    PlatformErrorCodes[(PlatformErrorCodes['ContentStackUnknownError'] = 176)] =
        'ContentStackUnknownError';
    PlatformErrorCodes[(PlatformErrorCodes['ContentStackNotFound'] = 177)] =
        'ContentStackNotFound';
    PlatformErrorCodes[(PlatformErrorCodes['ContentStackRateLimited'] = 178)] =
        'ContentStackRateLimited';
    PlatformErrorCodes[(PlatformErrorCodes['ContentStackTimeout'] = 179)] =
        'ContentStackTimeout';
    PlatformErrorCodes[(PlatformErrorCodes['ContentStackServiceError'] = 180)] =
        'ContentStackServiceError';
    PlatformErrorCodes[
        (PlatformErrorCodes['ContentStackDeserializationFailure'] = 181)
    ] = 'ContentStackDeserializationFailure';
    PlatformErrorCodes[(PlatformErrorCodes['UserNonUniqueName'] = 200)] =
        'UserNonUniqueName';
    PlatformErrorCodes[
    ...
    PlatformErrorCodes[(PlatformErrorCodes['UserInvalidMobileAppType'] = 207)] =
    ...
    PlatformErrorCodes[(PlatformErrorCodes['UserTermsOfUseRequired'] = 215)] =
    ...
    PlatformErrorCodes[(PlatformErrorCodes['UserInvalidAvatar'] = 218)] =
        'UserInvalidAvatar';
    PlatformErrorCodes[
    ...
    PlatformErrorCodes[(PlatformErrorCodes['UserCannotChangeEmail'] = 222)] =
    ...
    PlatformErrorCodes[(PlatformErrorCodes['UserEmailValidationLimit'] = 229)] =
    ...
    PlatformErrorCodes[(PlatformErrorCodes['MailServiceRateLimit'] = 232)] =
        'MailServiceRateLimit';
    PlatformErrorCodes[(PlatformErrorCodes['UserEmailMustBeVerified'] = 233)] =
    ...
    PlatformErrorCodes[(PlatformErrorCodes['ErrorDatabaseGlobalName'] = 239)] =
    ...
    PlatformErrorCodes[(PlatformErrorCodes['MessagingUnknownError'] = 300)] =
        'MessagingUnknownError';
    PlatformErrorCodes[(PlatformErrorCodes['MessagingSelfError'] = 301)] =
        'MessagingSelfError';
    PlatformErrorCodes[(PlatformErrorCodes['MessagingSendThrottle'] = 302)] =
        'MessagingSendThrottle';
    PlatformErrorCodes[(PlatformErrorCodes['MessagingNoBody'] = 303)] =
        'MessagingNoBody';
    PlatformErrorCodes[(PlatformErrorCodes['MessagingTooManyUsers'] = 304)] =
        'MessagingTooManyUsers';
    PlatformErrorCodes[
        (PlatformErrorCodes['MessagingCanNotLeaveConversation'] = 305)
    ] = 'MessagingCanNotLeaveConversation';
    PlatformErrorCodes[(PlatformErrorCodes['MessagingUnableToSend'] = 306)] =
    ...
    PlatformErrorCodes[(PlatformErrorCodes['MessagingSenderIsBanned'] = 311)] =
    ...
    PlatformErrorCodes[(PlatformErrorCodes['ForumBodyCannotBeEmpty'] = 500)] =
    ...
    PlatformErrorCodes[(PlatformErrorCodes['ForumAliasedTagError'] = 511)] =
        'ForumAliasedTagError';
    PlatformErrorCodes[(PlatformErrorCodes['ForumCannotLocateThread'] = 512)] =
        'ForumCannotLocateThread';
    PlatformErrorCodes[
        (PlatformErrorCodes['ForumUnknownExceptionEditPost'] = 513)
    ] = 'ForumUnknownExceptionEditPost';
    PlatformErrorCodes[(PlatformErrorCodes['ForumCannotLocatePost'] = 514)] =
    ...
    PlatformErrorCodes[(PlatformErrorCodes['ForumCannotGetRating'] = 518)] =
        'ForumCannotGetRating';
    PlatformErrorCodes[
        (PlatformErrorCodes['ForumUnknownExceptionGetRating'] = 519)
    ] = 'ForumUnknownExceptionGetRating';
    PlatformErrorCodes[(PlatformErrorCodes['ForumRatingsAccessError'] = 520)] =
    ...
    PlatformErrorCodes[(PlatformErrorCodes['ForumAuthorAccessError'] = 524)] =
        'ForumAuthorAccessError';
    PlatformErrorCodes[(PlatformErrorCodes['ForumGroupAccessError'] = 525)] =
    ...
    PlatformErrorCodes[(PlatformErrorCodes['ForumTopicDoesNotExist'] = 531)] =
    ...
    PlatformErrorCodes[(PlatformErrorCodes['ForumBodyTooLong'] = 536)] =
        'ForumBodyTooLong';
    PlatformErrorCodes[(PlatformErrorCodes['ForumSubjectTooLong'] = 537)] =
        'ForumSubjectTooLong';
    PlatformErrorCodes[
        (PlatformErrorCodes['ForumAnnouncementNotAllowed'] = 538)
    ] = 'ForumAnnouncementNotAllowed';
    PlatformErrorCodes[(PlatformErrorCodes['ForumCannotShareOwnPost'] = 539)] =
        'ForumCannotShareOwnPost';
    PlatformErrorCodes[(PlatformErrorCodes['ForumEditNoOp'] = 540)] =
        'ForumEditNoOp';
    PlatformErrorCodes[
    ...
    PlatformErrorCodes[(PlatformErrorCodes['ForumCanOnlyDeleteTopics'] = 557)] =
        'ForumCanOnlyDeleteTopics';
    PlatformErrorCodes[(PlatformErrorCodes['ForumDeleteSqlException'] = 558)] =
        'ForumDeleteSqlException';
    PlatformErrorCodes[
        (PlatformErrorCodes['ForumDeleteSqlUnknownResult'] = 559)
    ] = 'ForumDeleteSqlUnknownResult';
    PlatformErrorCodes[(PlatformErrorCodes['ForumTooManyTags'] = 560)] =
        'ForumTooManyTags';
    PlatformErrorCodes[(PlatformErrorCodes['ForumCanOnlyRateTopics'] = 561)] =
        'ForumCanOnlyRateTopics';
    PlatformErrorCodes[
        (PlatformErrorCodes['ForumBannedPostsCannotBeEdited'] = 562)
    ] = 'ForumBannedPostsCannotBeEdited';
    PlatformErrorCodes[(PlatformErrorCodes['ForumThreadRootIsBanned'] = 563)] =
    ...
    PlatformErrorCodes[(PlatformErrorCodes['ForumInvalidPollInput'] = 573)] =
    ...
    PlatformErrorCodes[(PlatformErrorCodes['ForumUnexpectedError'] = 577)] =
        'ForumUnexpectedError';
    PlatformErrorCodes[(PlatformErrorCodes['ForumAgeLock'] = 578)] =
        'ForumAgeLock';
    PlatformErrorCodes[(PlatformErrorCodes['ForumMaxPages'] = 579)] =
        'ForumMaxPages';
    PlatformErrorCodes[(PlatformErrorCodes['ForumMaxPagesOldestFirst'] = 580)] =
    ...
    PlatformErrorCodes[(PlatformErrorCodes['GroupInvalidId'] = 607)] =
        'GroupInvalidId';
    PlatformErrorCodes[(PlatformErrorCodes['GroupInvalidMembershipId'] = 608)] =
        'GroupInvalidMembershipId';
    PlatformErrorCodes[
        (PlatformErrorCodes['GroupInvalidMembershipType'] = 609)
    ] = 'GroupInvalidMembershipType';
    PlatformErrorCodes[(PlatformErrorCodes['GroupMissingTags'] = 610)] =
        'GroupMissingTags';
    PlatformErrorCodes[(PlatformErrorCodes['GroupMembershipNotFound'] = 611)] =
        'GroupMembershipNotFound';
    PlatformErrorCodes[(PlatformErrorCodes['GroupInvalidRating'] = 612)] =
        'GroupInvalidRating';
    PlatformErrorCodes[
    ...
    PlatformErrorCodes[(PlatformErrorCodes['GroupCreatorAccessError'] = 615)] =
        'GroupCreatorAccessError';
    PlatformErrorCodes[(PlatformErrorCodes['GroupAdminAccessError'] = 616)] =
    ...
    PlatformErrorCodes[(PlatformErrorCodes['GroupNotDeleted'] = 619)] =
        'GroupNotDeleted';
    PlatformErrorCodes[
        (PlatformErrorCodes['GroupUnknownErrorUndeletingGroup'] = 620)
    ] = 'GroupUnknownErrorUndeletingGroup';
    PlatformErrorCodes[(PlatformErrorCodes['GroupDeleted'] = 621)] =
        'GroupDeleted';
    PlatformErrorCodes[(PlatformErrorCodes['GroupNotFound'] = 622)] =
        'GroupNotFound';
    PlatformErrorCodes[(PlatformErrorCodes['GroupMemberBanned'] = 623)] =
        'GroupMemberBanned';
    PlatformErrorCodes[(PlatformErrorCodes['GroupMembershipClosed'] = 624)] =
        'GroupMembershipClosed';
    PlatformErrorCodes[
        (PlatformErrorCodes['GroupPrivatePostOverrideError'] = 625)
    ] = 'GroupPrivatePostOverrideError';
    PlatformErrorCodes[(PlatformErrorCodes['GroupNameTaken'] = 626)] =
        'GroupNameTaken';
    PlatformErrorCodes[
    ...
    PlatformErrorCodes[(PlatformErrorCodes['GroupAlreadyAllied'] = 641)] =
        'GroupAlreadyAllied';
    PlatformErrorCodes[(PlatformErrorCodes['GroupAlreadyMember'] = 642)] =
        'GroupAlreadyMember';
    PlatformErrorCodes[
    ...
    PlatformErrorCodes[(PlatformErrorCodes['GroupAtMaximumAlliances'] = 646)] =
    ...
    PlatformErrorCodes[(PlatformErrorCodes['GroupInvalidPlatformType'] = 650)] =
        'GroupInvalidPlatformType';
    PlatformErrorCodes[(PlatformErrorCodes['GroupMemberInvalidSort'] = 651)] =
        'GroupMemberInvalidSort';
    PlatformErrorCodes[(PlatformErrorCodes['GroupInvalidResolveState'] = 652)] =
    ...
    PlatformErrorCodes[(PlatformErrorCodes['GroupNotInAlliance'] = 663)] =
        'GroupNotInAlliance';
    PlatformErrorCodes[
    ...
    PlatformErrorCodes[(PlatformErrorCodes['GroupToGroupNotFollowing'] = 666)] =
        'GroupToGroupNotFollowing';
    PlatformErrorCodes[
        (PlatformErrorCodes['ClanMaximumMembershipReached'] = 667)
    ] = 'ClanMaximumMembershipReached';
    PlatformErrorCodes[(PlatformErrorCodes['ClanNameNotValid'] = 668)] =
        'ClanNameNotValid';
    PlatformErrorCodes[(PlatformErrorCodes['ClanNameNotValidError'] = 669)] =
        'ClanNameNotValidError';
    PlatformErrorCodes[(PlatformErrorCodes['AllianceOwnerNotDefined'] = 670)] =
        'AllianceOwnerNotDefined';
    PlatformErrorCodes[(PlatformErrorCodes['AllianceChildNotDefined'] = 671)] =
        'AllianceChildNotDefined';
    PlatformErrorCodes[
        (PlatformErrorCodes['ClanCultureIllegalCharacters'] = 672)
    ] = 'ClanCultureIllegalCharacters';
    PlatformErrorCodes[(PlatformErrorCodes['ClanTagIllegalCharacters'] = 673)] =
        'ClanTagIllegalCharacters';
    PlatformErrorCodes[(PlatformErrorCodes['ClanRequiresInvitation'] = 674)] =
        'ClanRequiresInvitation';
    PlatformErrorCodes[(PlatformErrorCodes['ClanMembershipClosed'] = 675)] =
        'ClanMembershipClosed';
    PlatformErrorCodes[(PlatformErrorCodes['ClanInviteAlreadyMember'] = 676)] =
        'ClanInviteAlreadyMember';
    PlatformErrorCodes[(PlatformErrorCodes['GroupInviteAlreadyMember'] = 677)] =
        'GroupInviteAlreadyMember';
    PlatformErrorCodes[
        (PlatformErrorCodes['GroupJoinApprovalRequired'] = 678)
    ] = 'GroupJoinApprovalRequired';
    PlatformErrorCodes[(PlatformErrorCodes['ClanTagRequired'] = 679)] =
        'ClanTagRequired';
    PlatformErrorCodes[
    ...
    PlatformErrorCodes[(PlatformErrorCodes['ClanMigrationFailed'] = 682)] =
        'ClanMigrationFailed';
    PlatformErrorCodes[
    ...
    PlatformErrorCodes[(PlatformErrorCodes['ClanNotFound'] = 686)] =
        'ClanNotFound';
    PlatformErrorCodes[
        (PlatformErrorCodes['ClanMembershipLevelDoesNotPermitThatAction'] = 687)
    ] = 'ClanMembershipLevelDoesNotPermitThatAction';
    PlatformErrorCodes[(PlatformErrorCodes['ClanMemberNotFound'] = 688)] =
        'ClanMemberNotFound';
    PlatformErrorCodes[
    ...
    PlatformErrorCodes[(PlatformErrorCodes['ClanNameAlreadyUsed'] = 691)] =
        'ClanNameAlreadyUsed';
    PlatformErrorCodes[(PlatformErrorCodes['ClanTooFewMembers'] = 692)] =
        'ClanTooFewMembers';
    PlatformErrorCodes[
        (PlatformErrorCodes['ClanInfoCannotBeWhitespace'] = 693)
    ] = 'ClanInfoCannotBeWhitespace';
    PlatformErrorCodes[(PlatformErrorCodes['GroupCultureThrottle'] = 694)] =
        'GroupCultureThrottle';
    PlatformErrorCodes[
        (PlatformErrorCodes['ClanTargetDisallowsInvites'] = 695)
    ] = 'ClanTargetDisallowsInvites';
    PlatformErrorCodes[(PlatformErrorCodes['ClanInvalidOperation'] = 696)] =
    ...
    PlatformErrorCodes[(PlatformErrorCodes['ClanNameReserved'] = 698)] =
        'ClanNameReserved';
    PlatformErrorCodes[
    ...
    PlatformErrorCodes[(PlatformErrorCodes['ActivitiesParameterNull'] = 702)] =
        'ActivitiesParameterNull';
    PlatformErrorCodes[(PlatformErrorCodes['ActivityCountsDiabled'] = 703)] =
        'ActivityCountsDiabled';
    PlatformErrorCodes[
        (PlatformErrorCodes['ActivitySearchInvalidParameters'] = 704)
    ] = 'ActivitySearchInvalidParameters';
    PlatformErrorCodes[(PlatformErrorCodes['ActivityPermissionDenied'] = 705)] =
        'ActivityPermissionDenied';
    PlatformErrorCodes[(PlatformErrorCodes['ShareAlreadyShared'] = 706)] =
        'ShareAlreadyShared';
    PlatformErrorCodes[(PlatformErrorCodes['ActivityLoggingDisabled'] = 707)] =
        'ActivityLoggingDisabled';
    PlatformErrorCodes[
        (PlatformErrorCodes['ClanRequiresExistingDestinyAccount'] = 750)
    ] = 'ClanRequiresExistingDestinyAccount';
    PlatformErrorCodes[(PlatformErrorCodes['ClanNameRestricted'] = 751)] =
        'ClanNameRestricted';
    PlatformErrorCodes[(PlatformErrorCodes['ClanCreationBan'] = 752)] =
        'ClanCreationBan';
    PlatformErrorCodes[
    ...
    PlatformErrorCodes[(PlatformErrorCodes['ItemAlreadyFollowed'] = 801)] =
        'ItemAlreadyFollowed';
    PlatformErrorCodes[(PlatformErrorCodes['ItemNotFollowed'] = 802)] =
        'ItemNotFollowed';
    PlatformErrorCodes[(PlatformErrorCodes['CannotFollowSelf'] = 803)] =
        'CannotFollowSelf';
    PlatformErrorCodes[(PlatformErrorCodes['GroupFollowLimitExceeded'] = 804)] =
        'GroupFollowLimitExceeded';
    PlatformErrorCodes[(PlatformErrorCodes['TagFollowLimitExceeded'] = 805)] =
        'TagFollowLimitExceeded';
    PlatformErrorCodes[(PlatformErrorCodes['UserFollowLimitExceeded'] = 806)] =
        'UserFollowLimitExceeded';
    PlatformErrorCodes[
        (PlatformErrorCodes['FollowUnsupportedEntityType'] = 807)
    ] = 'FollowUnsupportedEntityType';
    PlatformErrorCodes[(PlatformErrorCodes['NoValidTagsInList'] = 900)] =
        'NoValidTagsInList';
    PlatformErrorCodes[
    ...
    PlatformErrorCodes[(PlatformErrorCodes['NotAValidPartialTag'] = 903)] =
        'NotAValidPartialTag';
    PlatformErrorCodes[
    ...
    PlatformErrorCodes[(PlatformErrorCodes['TagNotFound'] = 907)] =
        'TagNotFound';
    PlatformErrorCodes[(PlatformErrorCodes['SingleTagExpected'] = 908)] =
        'SingleTagExpected';
    PlatformErrorCodes[
        (PlatformErrorCodes['TagsExceededMaximumPerItem'] = 909)
    ] = 'TagsExceededMaximumPerItem';
    PlatformErrorCodes[(PlatformErrorCodes['IgnoreInvalidParameters'] = 1000)] =
        'IgnoreInvalidParameters';
    PlatformErrorCodes[(PlatformErrorCodes['IgnoreSqlException'] = 1001)] =
        'IgnoreSqlException';
    PlatformErrorCodes[
    ...
    PlatformErrorCodes[(PlatformErrorCodes['IgnoreCannotIgnoreSelf'] = 1005)] =
        'IgnoreCannotIgnoreSelf';
    PlatformErrorCodes[(PlatformErrorCodes['IgnoreIllegalType'] = 1006)] =
        'IgnoreIllegalType';
    PlatformErrorCodes[(PlatformErrorCodes['IgnoreNotFound'] = 1007)] =
        'IgnoreNotFound';
    PlatformErrorCodes[
        (PlatformErrorCodes['IgnoreUserGloballyIgnored'] = 1008)
    ] = 'IgnoreUserGloballyIgnored';
    PlatformErrorCodes[(PlatformErrorCodes['IgnoreUserIgnored'] = 1009)] =
        'IgnoreUserIgnored';
    PlatformErrorCodes[(PlatformErrorCodes['TargetUserIgnored'] = 1010)] =
        'TargetUserIgnored';
    PlatformErrorCodes[
    ...
    PlatformErrorCodes[(PlatformErrorCodes['PSNExForbidden'] = 1205)] =
        'PSNExForbidden';
    PlatformErrorCodes[(PlatformErrorCodes['PSNExSystemDisabled'] = 1218)] =
        'PSNExSystemDisabled';
    PlatformErrorCodes[(PlatformErrorCodes['PsnApiErrorCodeUnknown'] = 1223)] =
        'PsnApiErrorCodeUnknown';
    PlatformErrorCodes[(PlatformErrorCodes['PsnApiErrorWebException'] = 1224)] =
        'PsnApiErrorWebException';
    PlatformErrorCodes[(PlatformErrorCodes['PsnApiBadRequest'] = 1225)] =
        'PsnApiBadRequest';
    PlatformErrorCodes[
    ...
    PlatformErrorCodes[(PlatformErrorCodes['PsnApiBannedUser'] = 1229)] =
        'PsnApiBannedUser';
    PlatformErrorCodes[
    ...
    PlatformErrorCodes[(PlatformErrorCodes['PsnApiServerBusy'] = 1232)] =
        'PsnApiServerBusy';
    PlatformErrorCodes[(PlatformErrorCodes['PsnApiUnderMaintenance'] = 1233)] =
    ...
    PlatformErrorCodes[(PlatformErrorCodes['PsnApiNoPermission'] = 1238)] =
        'PsnApiNoPermission';
    PlatformErrorCodes[(PlatformErrorCodes['PsnApiTargetUserBlocked'] = 1239)] =
        'PsnApiTargetUserBlocked';
    PlatformErrorCodes[(PlatformErrorCodes['PsnApiJwksMissing'] = 1240)] =
        'PsnApiJwksMissing';
    PlatformErrorCodes[
    ...
    PlatformErrorCodes[(PlatformErrorCodes['XblExSystemDisabled'] = 1300)] =
        'XblExSystemDisabled';
    PlatformErrorCodes[(PlatformErrorCodes['XblExUnknownError'] = 1301)] =
        'XblExUnknownError';
    PlatformErrorCodes[(PlatformErrorCodes['XblApiErrorWebException'] = 1302)] =
        'XblApiErrorWebException';
    PlatformErrorCodes[(PlatformErrorCodes['XblStsTokenInvalid'] = 1303)] =
        'XblStsTokenInvalid';
    PlatformErrorCodes[(PlatformErrorCodes['XblStsMissingToken'] = 1304)] =
        'XblStsMissingToken';
    PlatformErrorCodes[(PlatformErrorCodes['XblStsExpiredToken'] = 1305)] =
        'XblStsExpiredToken';
    PlatformErrorCodes[
        (PlatformErrorCodes['XblAccessToTheSandboxDenied'] = 1306)
    ] = 'XblAccessToTheSandboxDenied';
    PlatformErrorCodes[(PlatformErrorCodes['XblMsaResponseMissing'] = 1307)] =
        'XblMsaResponseMissing';
    PlatformErrorCodes[
        (PlatformErrorCodes['XblMsaAccessTokenExpired'] = 1308)
    ] = 'XblMsaAccessTokenExpired';
    PlatformErrorCodes[(PlatformErrorCodes['XblMsaInvalidRequest'] = 1309)] =
        'XblMsaInvalidRequest';
    PlatformErrorCodes[
        (PlatformErrorCodes['XblMsaFriendsRequireSignIn'] = 1310)
    ] = 'XblMsaFriendsRequireSignIn';
    PlatformErrorCodes[(PlatformErrorCodes['XblUserActionRequired'] = 1311)] =
        'XblUserActionRequired';
    PlatformErrorCodes[(PlatformErrorCodes['XblParentalControls'] = 1312)] =
        'XblParentalControls';
    PlatformErrorCodes[(PlatformErrorCodes['XblDeveloperAccount'] = 1313)] =
        'XblDeveloperAccount';
    PlatformErrorCodes[(PlatformErrorCodes['XblUserTokenExpired'] = 1314)] =
        'XblUserTokenExpired';
    PlatformErrorCodes[(PlatformErrorCodes['XblUserTokenInvalid'] = 1315)] =
        'XblUserTokenInvalid';
    PlatformErrorCodes[(PlatformErrorCodes['XblOffline'] = 1316)] =
        'XblOffline';
    PlatformErrorCodes[(PlatformErrorCodes['XblUnknownErrorCode'] = 1317)] =
        'XblUnknownErrorCode';
    PlatformErrorCodes[(PlatformErrorCodes['XblMsaInvalidGrant'] = 1318)] =
        'XblMsaInvalidGrant';
    PlatformErrorCodes[(PlatformErrorCodes['ReportNotYetResolved'] = 1400)] =
        'ReportNotYetResolved';
    PlatformErrorCodes[
        (PlatformErrorCodes['ReportOverturnDoesNotChangeDecision'] = 1401)
    ] = 'ReportOverturnDoesNotChangeDecision';
    PlatformErrorCodes[(PlatformErrorCodes['ReportNotFound'] = 1402)] =
        'ReportNotFound';
    PlatformErrorCodes[(PlatformErrorCodes['ReportAlreadyReported'] = 1403)] =
        'ReportAlreadyReported';
    PlatformErrorCodes[(PlatformErrorCodes['ReportInvalidResolution'] = 1404)] =
        'ReportInvalidResolution';
    PlatformErrorCodes[(PlatformErrorCodes['ReportNotAssignedToYou'] = 1405)] =
    ...
    PlatformErrorCodes[(PlatformErrorCodes['DestinyAccountNotFound'] = 1601)] =
    ...
    PlatformErrorCodes[(PlatformErrorCodes['DestinyUnexpectedError'] = 1618)] =
        'DestinyUnexpectedError';
    PlatformErrorCodes[(PlatformErrorCodes['DestinyInvalidAction'] = 1619)] =
        'DestinyInvalidAction';
    PlatformErrorCodes[
        (PlatformErrorCodes['DestinyCharacterNotFound'] = 1620)
    ] = 'DestinyCharacterNotFound';
    PlatformErrorCodes[(PlatformErrorCodes['DestinyInvalidFlag'] = 1621)] =
        'DestinyInvalidFlag';
    PlatformErrorCodes[(PlatformErrorCodes['DestinyInvalidRequest'] = 1622)] =
        'DestinyInvalidRequest';
    PlatformErrorCodes[(PlatformErrorCodes['DestinyItemNotFound'] = 1623)] =
        'DestinyItemNotFound';
    PlatformErrorCodes[
    ...
    PlatformErrorCodes[(PlatformErrorCodes['DestinyInternalError'] = 1626)] =
        'DestinyInternalError';
    PlatformErrorCodes[(PlatformErrorCodes['DestinyVendorNotFound'] = 1627)] =
    ...
    PlatformErrorCodes[(PlatformErrorCodes['DestinyBucketNotFound'] = 1633)] =
    ...
    PlatformErrorCodes[(PlatformErrorCodes['DestinyInventoryFull'] = 1637)] =
    ...
    PlatformErrorCodes[(PlatformErrorCodes['DestinyItemUnequippable'] = 1640)] =
    ...
    PlatformErrorCodes[(PlatformErrorCodes['DestinyServiceFailure'] = 1643)] =
        'DestinyServiceFailure';
    PlatformErrorCodes[(PlatformErrorCodes['DestinyServiceRetired'] = 1644)] =
        'DestinyServiceRetired';
    PlatformErrorCodes[(PlatformErrorCodes['DestinyTransferFailed'] = 1645)] =
    ...
    PlatformErrorCodes[(PlatformErrorCodes['DestinyPGCRNotFound'] = 1653)] =
        'DestinyPGCRNotFound';
    PlatformErrorCodes[
    ...
    PlatformErrorCodes[(PlatformErrorCodes['DestinyRefundInvalid'] = 1664)] =
    ...
    PlatformErrorCodes[(PlatformErrorCodes['DestinyItemLocked'] = 1674)] =
        'DestinyItemLocked';
    PlatformErrorCodes[
    ...
    PlatformErrorCodes[(PlatformErrorCodes['DestinySocketNotFound'] = 1677)] =
    ...
    PlatformErrorCodes[(PlatformErrorCodes['FbInvalidRequest'] = 1800)] =
        'FbInvalidRequest';
    PlatformErrorCodes[(PlatformErrorCodes['FbRedirectMismatch'] = 1801)] =
        'FbRedirectMismatch';
    PlatformErrorCodes[(PlatformErrorCodes['FbAccessDenied'] = 1802)] =
        'FbAccessDenied';
    PlatformErrorCodes[
        (PlatformErrorCodes['FbUnsupportedResponseType'] = 1803)
    ] = 'FbUnsupportedResponseType';
    PlatformErrorCodes[(PlatformErrorCodes['FbInvalidScope'] = 1804)] =
        'FbInvalidScope';
    PlatformErrorCodes[(PlatformErrorCodes['FbUnsupportedGrantType'] = 1805)] =
        'FbUnsupportedGrantType';
    PlatformErrorCodes[(PlatformErrorCodes['FbInvalidGrant'] = 1806)] =
        'FbInvalidGrant';
    PlatformErrorCodes[(PlatformErrorCodes['InvitationExpired'] = 1900)] =
        'InvitationExpired';
    PlatformErrorCodes[(PlatformErrorCodes['InvitationUnknownType'] = 1901)] =
        'InvitationUnknownType';
    PlatformErrorCodes[
        (PlatformErrorCodes['InvitationInvalidResponseStatus'] = 1902)
    ] = 'InvitationInvalidResponseStatus';
    PlatformErrorCodes[(PlatformErrorCodes['InvitationInvalidType'] = 1903)] =
    ...
    PlatformErrorCodes[(PlatformErrorCodes['InvitationInvalidCode'] = 1906)] =
    ...
    PlatformErrorCodes[(PlatformErrorCodes['InvitationNoRecipients'] = 1910)] =
    ...
    PlatformErrorCodes[(PlatformErrorCodes['InvitationInvalid'] = 1913)] =
        'InvitationInvalid';
    PlatformErrorCodes[(PlatformErrorCodes['InvitationNotFound'] = 1914)] =
        'InvitationNotFound';
    PlatformErrorCodes[(PlatformErrorCodes['TokenInvalid'] = 2000)] =
        'TokenInvalid';
    PlatformErrorCodes[(PlatformErrorCodes['TokenBadFormat'] = 2001)] =
        'TokenBadFormat';
    PlatformErrorCodes[(PlatformErrorCodes['TokenAlreadyClaimed'] = 2002)] =
        'TokenAlreadyClaimed';
    PlatformErrorCodes[(PlatformErrorCodes['TokenAlreadyClaimedSelf'] = 2003)] =
        'TokenAlreadyClaimedSelf';
    PlatformErrorCodes[(PlatformErrorCodes['TokenThrottling'] = 2004)] =
        'TokenThrottling';
    PlatformErrorCodes[
    ...
    PlatformErrorCodes[(PlatformErrorCodes['TokenInvalidOfferKey'] = 2008)] =
        'TokenInvalidOfferKey';
    PlatformErrorCodes[(PlatformErrorCodes['TokenEmailNotValidated'] = 2009)] =
    ...
    PlatformErrorCodes[(PlatformErrorCodes['TokenUserAgeNotVerified'] = 2013)] =
        'TokenUserAgeNotVerified';
    PlatformErrorCodes[
        (PlatformErrorCodes['TokenExceededOfferMaximum'] = 2014)
    ] = 'TokenExceededOfferMaximum';
    PlatformErrorCodes[(PlatformErrorCodes['TokenNoAvailableUnlocks'] = 2015)] =
    ...
    PlatformErrorCodes[(PlatformErrorCodes['TokenOfferExpired'] = 2021)] =
        'TokenOfferExpired';
    PlatformErrorCodes[
        (PlatformErrorCodes['RAFExceededMaximumReferrals'] = 2022)
    ] = 'RAFExceededMaximumReferrals';
    PlatformErrorCodes[(PlatformErrorCodes['RAFDuplicateBond'] = 2023)] =
        'RAFDuplicateBond';
    PlatformErrorCodes[
        (PlatformErrorCodes['RAFNoValidVeteranDestinyMembershipsFound'] = 2024)
    ] = 'RAFNoValidVeteranDestinyMembershipsFound';
    PlatformErrorCodes[(PlatformErrorCodes['RAFNotAValidVeteranUser'] = 2025)] =
    ...
    PlatformErrorCodes[(PlatformErrorCodes['RAFUnableToCreateBond'] = 2029)] =
        'RAFUnableToCreateBond';
    PlatformErrorCodes[(PlatformErrorCodes['RAFUnableToFindBond'] = 2030)] =
        'RAFUnableToFindBond';
    PlatformErrorCodes[(PlatformErrorCodes['RAFUnableToRemoveBond'] = 2031)] =
        'RAFUnableToRemoveBond';
    PlatformErrorCodes[(PlatformErrorCodes['RAFCannotBondToSelf'] = 2032)] =
        'RAFCannotBondToSelf';
    PlatformErrorCodes[(PlatformErrorCodes['RAFInvalidPlatform'] = 2033)] =
        'RAFInvalidPlatform';
    PlatformErrorCodes[(PlatformErrorCodes['RAFGenerateThrottled'] = 2034)] =
    ...
    PlatformErrorCodes[(PlatformErrorCodes['RAFRedeemThrottled'] = 2037)] =
        'RAFRedeemThrottled';
    PlatformErrorCodes[(PlatformErrorCodes['NoAvailableDiscountCode'] = 2038)] =
        'NoAvailableDiscountCode';
    PlatformErrorCodes[(PlatformErrorCodes['DiscountAlreadyClaimed'] = 2039)] =
        'DiscountAlreadyClaimed';
    PlatformErrorCodes[(PlatformErrorCodes['DiscountClaimFailure'] = 2040)] =
    ...
    PlatformErrorCodes[(PlatformErrorCodes['DiscountAlreadyExists'] = 2043)] =
    ...
    PlatformErrorCodes[(PlatformErrorCodes['OfferRequired'] = 2046)] =
        'OfferRequired';
    PlatformErrorCodes[
    ...
    PlatformErrorCodes[(PlatformErrorCodes['MissingOfferConfig'] = 2051)] =
        'MissingOfferConfig';
    PlatformErrorCodes[
    ...
    PlatformErrorCodes[(PlatformErrorCodes['RAFTooEarlyToCancelBond'] = 2056)] =
    ...
    PlatformErrorCodes[(PlatformErrorCodes['PartnerOfferSkuNotFound'] = 2061)] =
        'PartnerOfferSkuNotFound';
    PlatformErrorCodes[(PlatformErrorCodes['PartnerOfferSkuExpired'] = 2062)] =
    ...
    PlatformErrorCodes[(PlatformErrorCodes['ApiExceededMaxKeys'] = 2100)] =
        'ApiExceededMaxKeys';
    PlatformErrorCodes[(PlatformErrorCodes['ApiInvalidOrExpiredKey'] = 2101)] =
        'ApiInvalidOrExpiredKey';
    PlatformErrorCodes[
        (PlatformErrorCodes['ApiKeyMissingFromRequest'] = 2102)
    ] = 'ApiKeyMissingFromRequest';
    PlatformErrorCodes[(PlatformErrorCodes['ApplicationDisabled'] = 2103)] =
        'ApplicationDisabled';
    PlatformErrorCodes[(PlatformErrorCodes['ApplicationExceededMax'] = 2104)] =
    ...
    PlatformErrorCodes[(PlatformErrorCodes['ApplicationNameIsTaken'] = 2109)] =
        'ApplicationNameIsTaken';
    PlatformErrorCodes[(PlatformErrorCodes['RefreshTokenNotYetValid'] = 2110)] =
        'RefreshTokenNotYetValid';
    PlatformErrorCodes[(PlatformErrorCodes['AccessTokenHasExpired'] = 2111)] =
    ...
    PlatformErrorCodes[(PlatformErrorCodes['OAuthAccessTokenExpired'] = 2115)] =
    ...
    PlatformErrorCodes[(PlatformErrorCodes['RefreshTokenExpired'] = 2118)] =
        'RefreshTokenExpired';
    PlatformErrorCodes[
        (PlatformErrorCodes['AuthorizationRecordInvalid'] = 2119)
    ] = 'AuthorizationRecordInvalid';
    PlatformErrorCodes[(PlatformErrorCodes['TokenPreviouslyRevoked'] = 2120)] =
        'TokenPreviouslyRevoked';
    PlatformErrorCodes[(PlatformErrorCodes['TokenInvalidMembership'] = 2121)] =
        'TokenInvalidMembership';
    PlatformErrorCodes[(PlatformErrorCodes['AuthorizationCodeStale'] = 2122)] =
    ...
    PlatformErrorCodes[(PlatformErrorCodes['PartnershipInvalidType'] = 2200)] =
    ...
    PlatformErrorCodes[(PlatformErrorCodes['PartnershipDisabled'] = 2206)] =
        'PartnershipDisabled';
    PlatformErrorCodes[
    ...
    PlatformErrorCodes[(PlatformErrorCodes['TwitchNotLinked'] = 2500)] =
        'TwitchNotLinked';
    PlatformErrorCodes[(PlatformErrorCodes['TwitchAccountNotFound'] = 2501)] =
    ...
    PlatformErrorCodes[(PlatformErrorCodes['TwitchRequiresRelinking'] = 2505)] =
        'TwitchRequiresRelinking';
    PlatformErrorCodes[(PlatformErrorCodes['TwitchNoPlatformChosen'] = 2506)] =
    ...
    PlatformErrorCodes[(PlatformErrorCodes['TwitchNotAuthorized'] = 2509)] =
        'TwitchNotAuthorized';
    PlatformErrorCodes[
    ...
    PlatformErrorCodes[(PlatformErrorCodes['ReportOffenderNotInPgcr'] = 2700)] =
        'ReportOffenderNotInPgcr';
    PlatformErrorCodes[
        (PlatformErrorCodes['ReportRequestorNotInPgcr'] = 2701)
    ] = 'ReportRequestorNotInPgcr';
    PlatformErrorCodes[(PlatformErrorCodes['ReportSubmissionFailed'] = 2702)] =
        'ReportSubmissionFailed';
    PlatformErrorCodes[(PlatformErrorCodes['ReportCannotReportSelf'] = 2703)] =
        'ReportCannotReportSelf';
    PlatformErrorCodes[(PlatformErrorCodes['AwaTypeDisabled'] = 2800)] =
        'AwaTypeDisabled';
    PlatformErrorCodes[
    ...
    PlatformErrorCodes[(PlatformErrorCodes['SteamWebApiError'] = 2900)] =
        'SteamWebApiError';
    PlatformErrorCodes[
        (PlatformErrorCodes['SteamWebNullResponseError'] = 2901)
    ] = 'SteamWebNullResponseError';
    PlatformErrorCodes[(PlatformErrorCodes['SteamAccountRequired'] = 2902)] =
        'SteamAccountRequired';
    PlatformErrorCodes[(PlatformErrorCodes['SteamNotAuthorized'] = 2903)] =
        'SteamNotAuthorized';
    PlatformErrorCodes[(PlatformErrorCodes['ClanFireteamNotFound'] = 3000)] =
    ...
    PlatformErrorCodes[(PlatformErrorCodes['ClanFireteamFull'] = 3002)] =
        'ClanFireteamFull';
    PlatformErrorCodes[(PlatformErrorCodes['ClanFireteamAltFull'] = 3003)] =
        'ClanFireteamAltFull';
    PlatformErrorCodes[(PlatformErrorCodes['ClanFireteamBlocked'] = 3004)] =
        'ClanFireteamBlocked';
    PlatformErrorCodes[
        (PlatformErrorCodes['ClanFireteamPlayerEntryNotFound'] = 3005)
    ] = 'ClanFireteamPlayerEntryNotFound';
    PlatformErrorCodes[(PlatformErrorCodes['ClanFireteamPermissions'] = 3006)] =
    ...
    PlatformErrorCodes[(PlatformErrorCodes['ClanFireteamExpired'] = 3026)] =
        'ClanFireteamExpired';
    PlatformErrorCodes[
    ...
    PlatformErrorCodes[(PlatformErrorCodes['ClanFireteamThrottle'] = 3029)] =
    ...
    PlatformErrorCodes[(PlatformErrorCodes['CrossSaveRequestInvalid'] = 3204)] =
    ...
    PlatformErrorCodes[(PlatformErrorCodes['PCMigrationMissingSteam'] = 3401)] =
        'PCMigrationMissingSteam';
    PlatformErrorCodes[
        (PlatformErrorCodes['PCMigrationInvalidBlizzard'] = 3402)
    ] = 'PCMigrationInvalidBlizzard';
    PlatformErrorCodes[(PlatformErrorCodes['PCMigrationInvalidSteam'] = 3403)] =
    ...
    PlatformErrorCodes[(PlatformErrorCodes['PCMigrationNotLinked'] = 3406)] =
        'PCMigrationNotLinked';
    PlatformErrorCodes[
        (PlatformErrorCodes['PCMigrationAccountsAlreadyUsed'] = 3407)
    ] = 'PCMigrationAccountsAlreadyUsed';
    PlatformErrorCodes[(PlatformErrorCodes['PCMigrationStepFailed'] = 3408)] =
    ...
    PlatformErrorCodes[(PlatformErrorCodes['UnsupportedBrowser'] = 3500)] =
        'UnsupportedBrowser';
    PlatformErrorCodes[(PlatformErrorCodes['StadiaAccountRequired'] = 3600)] =
    ...
    PlatformErrorCodes[(PlatformErrorCodes['ApplePushErrorUnknown'] = 3800)] =
        'ApplePushErrorUnknown';
    PlatformErrorCodes[(PlatformErrorCodes['ApplePushErrorNull'] = 3801)] =
        'ApplePushErrorNull';
    PlatformErrorCodes[(PlatformErrorCodes['ApplePushErrorTimeout'] = 3802)] =
        'ApplePushErrorTimeout';
    PlatformErrorCodes[(PlatformErrorCodes['ApplePushBadRequest'] = 3803)] =
        'ApplePushBadRequest';
    PlatformErrorCodes[(PlatformErrorCodes['ApplePushFailedAuth'] = 3804)] =
        'ApplePushFailedAuth';
    PlatformErrorCodes[(PlatformErrorCodes['ApplePushThrottled'] = 3805)] =
        'ApplePushThrottled';
    PlatformErrorCodes[
        (PlatformErrorCodes['ApplePushServiceUnavailable'] = 3806)
    ] = 'ApplePushServiceUnavailable';
    PlatformErrorCodes[(PlatformErrorCodes['NotAnImageOrVideo'] = 3807)] =
        'NotAnImageOrVideo';
    PlatformErrorCodes[
    ...
    PlatformErrorCodes[(PlatformErrorCodes['ErrorBungieFriendsSelf'] = 3907)] =
        'ErrorBungieFriendsSelf';
    PlatformErrorCodes[(PlatformErrorCodes['ErrorBungieBlockSelf'] = 3908)] =
    ...
    PlatformErrorCodes[(PlatformErrorCodes['ErrorEgsUnknown'] = 4000)] =
        'ErrorEgsUnknown';
    PlatformErrorCodes[(PlatformErrorCodes['ErrorEgsBadRequest'] = 4001)] =
        'ErrorEgsBadRequest';
    PlatformErrorCodes[(PlatformErrorCodes['ErrorEgsNotAuthorized'] = 4002)] =
        'ErrorEgsNotAuthorized';
    PlatformErrorCodes[(PlatformErrorCodes['ErrorEgsForbidden'] = 4003)] =
        'ErrorEgsForbidden';
    PlatformErrorCodes[(PlatformErrorCodes['ErrorEgsAccountNotFound'] = 4004)] =
        'ErrorEgsAccountNotFound';
    PlatformErrorCodes[(PlatformErrorCodes['ErrorEgsWebException'] = 4005)] =
        'ErrorEgsWebException';
    PlatformErrorCodes[(PlatformErrorCodes['ErrorEgsUnavailable'] = 4006)] =
        'ErrorEgsUnavailable';
    PlatformErrorCodes[(PlatformErrorCodes['ErrorEgsJwksMissing'] = 4007)] =
        'ErrorEgsJwksMissing';
    PlatformErrorCodes[
