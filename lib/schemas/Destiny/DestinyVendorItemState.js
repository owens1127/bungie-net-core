...
/**
 * @typedef {number | DestinyVendorItemState.None | DestinyVendorItemState.Incomplete | DestinyVendorItemState.RewardAvailable | DestinyVendorItemState.Complete | DestinyVendorItemState.New | DestinyVendorItemState.Featured | DestinyVendorItemState.Ending | DestinyVendorItemState.OnSale | DestinyVendorItemState.Owned | DestinyVendorItemState.WideView | DestinyVendorItemState.NexusAttention | DestinyVendorItemState.SetDiscount | DestinyVendorItemState.PriceDrop | DestinyVendorItemState.DailyOffer | DestinyVendorItemState.Charity | DestinyVendorItemState.SeasonalRewardExpiration | DestinyVendorItemState.BestDeal | DestinyVendorItemState.Popular | DestinyVendorItemState.Free | DestinyVendorItemState.Locked} DestinyVendorItemState
 ...
 * @type DestinyVendorItemState
 * @see {@link https://bungie-net.github.io/#/components/schemas/Destiny.DestinyVendorItemState}
*/
const DestinyVendorItemState = Object.freeze({
...
module.exports = DestinyVendorItemState
