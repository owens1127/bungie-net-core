 ...
 * @property {Object.key<number, DestinyStat>} stats If the item has stats that it provides (damage, defense, etc...), it will be given here. Mapped to DestinyStatDefinition in the manifest.
...
module.exports = DestinyItemStatsComponent;
