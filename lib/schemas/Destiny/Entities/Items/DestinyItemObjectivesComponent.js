 ...
 * @property {DestinyObjectiveProgress[]} objectives If the item has a hard association with objectives, your progress on them will be defined here. 
 ...
 * @property {string?} dateCompleted If we have any information on when these objectives were completed, this will be the date of that completion. This won't be on many items, but could be interesting for some items that do store this information.
...
module.exports = DestinyItemObjectivesComponent;
