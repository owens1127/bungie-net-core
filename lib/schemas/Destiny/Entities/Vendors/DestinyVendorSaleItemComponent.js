...
module.exports = class DestinyVendorSaleItemComponent {
  ...
  */
   ...
   * @readonly
   * @type {import('../../DestinyUnlockStatus')[]}
  */
  unlockStatuses;
  /**
  ...
  */
   ...
   * use bitwise operators to check which of these match your value.
   * @readonly
   * @type {import('../../DestinyVendorItemState')}
  */
  augments;
  /**
