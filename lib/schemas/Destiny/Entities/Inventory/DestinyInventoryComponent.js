 ...
 * @property {DestinyItemComponent[]} items The items in this inventory. If you care to bucket them, use the item's bucketHash property to group them.
...
module.exports = DestinyInventoryComponent;
