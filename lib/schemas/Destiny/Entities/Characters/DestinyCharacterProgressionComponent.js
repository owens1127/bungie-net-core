...
module.exports = class DestinyCharacterProgressionComponent {
   ...
   * @readonly
   * @type {{{[key: number]: DestinyProgression}}}
  */
  progressions;
  /**
   ...
   * @readonly
   * @type {{{[key: number]: DestinyFactionProgression}}}
  */
  factions;
  /**
   ...
   * @readonly
   * @type {{{[key: number]: DestinyMilestone}}}
  */
  milestones;
  /**
   ...
   * @readonly
   * @type {import('../../Quests/DestinyQuestStatus')[]}
  */
  quests;
  /**
   ...
   * @readonly
   * @type {{{[key: number]: DestinyObjectiveProgress[]}}}
  */
   ...
   * @readonly
   * @type {{{[key: number]: DestinyItemPerksComponent}}}
  */
   ...
   * @readonly
   * @type {{{[key: number]: {{[key: number]: boolean}}}}}
  */
  checklists;
  /**
   ...
   * character.
   * @readonly
   * @type {import('../../Artifacts/DestinyArtifactCharacterScoped')}
  */
  seasonalArtifact;
}
