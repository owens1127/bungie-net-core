...
module.exports = class DestinyCharacterRenderComponent {
  ...
  */
   ...
   * @readonly
   * @type {import('../../Character/DestinyCharacterCustomization')}
  */
  customization;
  /**
   * A minimal view of:
   ...
   * character.
   * @readonly
   * @type {import('../../Character/DestinyCharacterPeerView')}
  */
  peerView;
}
