 ...
 * @property {DyeReference[]} customDyes Custom dyes, calculated by iterating over the character's equipped items. Useful for pre-fetching all of the dye data needed from our server.
 * @property {DestinyCharacterCustomization} customization This is actually something that Spasm.js *doesn't* do right now, and that we don't return assets for yet. This is the data about what character customization options you picked. You can combine this with DestinyCharacterCustomizationOptionDefinition to show some cool info, and hopefully someday to actually render a user's face in 3D. We'll see if we ever end up with time for that.
 * @property {DestinyCharacterPeerView} peerView A minimal view of:
- Equipped items
...
module.exports = DestinyCharacterRenderComponent;
