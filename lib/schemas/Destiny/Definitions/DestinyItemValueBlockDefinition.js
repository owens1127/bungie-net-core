 ...
 * @property {DestinyItemQuantity[]} itemValue References to the items that make up this item's "value", and the quantity.
 * @property {string} valueDescription If there's a localized text description of the value provided, this will be said description.
...
module.exports = DestinyItemValueBlockDefinition;
