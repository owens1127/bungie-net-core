 ...
 * @property {DestinyStatAggregationType} aggregationType Stats can exist on a character or an item, and they may potentially be aggregated in different ways. The DestinyStatAggregationType enum value indicates the way that this stat is being aggregated.
 * @property {boolean} hasComputedBlock True if the stat is computed rather than being delivered as a raw value on items.
For instance, the Light stat in Destiny 1 was a computed stat.
 * @property {DestinyStatCategory} statCategory The category of the stat, according to the game.
...
module.exports = DestinyStatDefinition;
