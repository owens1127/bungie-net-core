 ...
 * @property {number} statHash The hash identifier of the stat whose display properties are being overridden. Mapped to DestinyStatDefinition in the manifest.
 * @property {DestinyDisplayPropertiesDefinition} displayProperties The display properties to show instead of the base DestinyStatDefinition display properties.
...
module.exports = DestinyStatOverrideDefinition;
