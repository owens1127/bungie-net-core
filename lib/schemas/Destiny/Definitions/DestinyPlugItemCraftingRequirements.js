...
/**
 * @type {typeof DestinyPlugItemCraftingRequirements}
 * @see {@link https://bungie-net.github.io/#/components/schemas/Destiny.Definitions.DestinyPlugItemCraftingRequirements}
*/
module.exports = class DestinyPlugItemCraftingRequirements {
  /**
   * @readonly
   * @type import('./DestinyPlugItemCraftingUnlockRequirement')[]
  */
  unlockRequirements;
  /**
