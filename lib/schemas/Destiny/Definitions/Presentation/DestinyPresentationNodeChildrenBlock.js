 ...
 * entity (if anything)
 * @type {typeof DestinyPresentationNodeChildrenBlock}
...
*/
module.exports = class DestinyPresentationNodeChildrenBlock {
  /**
   * @readonly
   * @type import('./DestinyPresentationNodeChildEntry')[]
  */
  presentationNodes;
  /**
   * @readonly
   * @type import('./DestinyPresentationNodeCollectibleChildEntry')[]
  */
  collectibles;
  /**
   * @readonly
   * @type import('./DestinyPresentationNodeRecordChildEntry')[]
  */
  records;
  /**
   * @readonly
   * @type import('./DestinyPresentationNodeMetricChildEntry')[]
  */
  metrics;
  /**
   * @readonly
   * @type import('./DestinyPresentationNodeCraftableChildEntry')[]
  */
  craftables;
}
