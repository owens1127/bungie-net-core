 ...
 * @property {number} order The recommended order in which to render the groups, Ascending order.
 * @property {string} categoryName For now, a group just has a name.
...
module.exports = DestinyVendorGroupDefinition;
