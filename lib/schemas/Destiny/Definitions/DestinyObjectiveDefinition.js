...
module.exports = class DestinyObjectiveDefinition {
  ...
  */
   ...
   * @readonly
   * @type {import('../DestinyUnlockValueUIStyle')}
  */
  valueStyle;
  /**
  ...
  */
   ...
   * are defined here.
   * @readonly
   * @type {import('./DestinyObjectivePerkEntryDefinition')}
  */
  perks;
  /**
   ...
   * @readonly
   * @type {import('./DestinyObjectiveStatEntryDefinition')}
  */
  stats;
  /**
  ...
  */
   ...
   * @readonly
   * @type {import('../DestinyObjectiveUiStyle')}
  */
  uiStyle;
  /**
