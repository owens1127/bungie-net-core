...
module.exports = class DestinyDestinationDefinition {
  ...
  */
   ...
   * @readonly
   * @type import('./DestinyDestinationBubbleSettingDefinition')[]
  */
  bubbleSettings;
  /**
   ...
   * @readonly
   * @type import('./DestinyBubbleDefinition')[]
  */
  bubbles;
  /**
