 ...
 * @property {number} placeHash The place that "owns" this Destination. Use this hash to look up the DestinyPlaceDefinition. Mapped to DestinyPlaceDefinition in the manifest.
 * @property {number} defaultFreeroamActivityHash If this Destination has a default Free-Roam activity, this is the hash for that Activity. Use it to look up the DestinyActivityDefintion. Mapped to DestinyActivityDefinition in the manifest.
 * @property {DestinyActivityGraphListEntryDefinition[]} activityGraphEntries If the Destination has default Activity Graphs (i.e. "Map") that should be shown in the director, this is the list of those Graphs. At most, only one should be active at any given time for a Destination: these would represent, for example, different variants on a Map if the Destination is changing on a macro level based on game state.
 * @property {DestinyDestinationBubbleSettingDefinition[]} bubbleSettings A Destination may have many "Bubbles" zones with human readable properties.
 ...
 * @property {DestinyBubbleDefinition[]} bubbles This provides the unique identifiers for every bubble in the destination (only guaranteed unique within the destination), and any intrinsic properties of the bubble.
...
module.exports = DestinyDestinationDefinition;
