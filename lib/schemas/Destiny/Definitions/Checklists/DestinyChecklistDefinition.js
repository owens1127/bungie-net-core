 ...
 * @type DestinyChecklistDefinition
 * @property {DestinyDisplayPropertiesDefinition} displayProperties 
 * @property {string} viewActionString A localized string prompting you to view the checklist.
 * @property {DestinyScope} scope Indicates whether you will find this checklist on the Profile or Character components.
 * @property {DestinyChecklistEntryDefinition[]} entries The individual checklist items. Gotta catch 'em all.
...
module.exports = DestinyChecklistDefinition;
