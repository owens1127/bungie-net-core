...
/**
 * @type {typeof DestinyItemSocketEntryPlugItemRandomizedDefinition}
...
*/
module.exports = class DestinyItemSocketEntryPlugItemRandomizedDefinition {
  /**
   * @readonly
   * @type {import('./DestinyPlugItemCraftingRequirements')}
  */
