 ...
 * @property {number} categoryHash The hash identifier of the Plug Category to compare against the plug item's plug.plugCategoryHash.
Note that this does NOT relate to any Definition in itself, it is only used for comparison purposes.
 * @property {string} categoryIdentifier The string identifier for the category, which is here mostly for debug purposes.
 * @property {number[]} reinitializationPossiblePlugHashes The list of all plug items (DestinyInventoryItemDefinition) that the socket may randomly be populated with when reinitialized.
...
module.exports = DestinyPlugWhitelistEntryDefinition;
