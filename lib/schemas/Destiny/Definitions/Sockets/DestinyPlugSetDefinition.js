 ...
 * @property {DestinyDisplayPropertiesDefinition} displayProperties If you want to show these plugs in isolation, these are the display properties for them.
 * @property {DestinyItemSocketEntryPlugItemRandomizedDefinition[]} reusablePlugItems This is a list of pre-determined plugs that can be plugged into this socket, without the character having the plug in their inventory.
 ...
 * @property {boolean} isFakePlugSet Mostly for our debugging or reporting bugs, BNet is making "fake" plug sets in a desperate effort to reduce socket sizes.
...
module.exports = DestinyPlugSetDefinition;
