...
module.exports = class DestinySocketTypeDefinition {
  ...
  */
   ...
   * @readonly
   * @type {import('./DestinyInsertPlugActionDefinition')}
  */
  insertAction;
  /**
   ...
   * @readonly
   * @type {import('./DestinyPlugWhitelistEntryDefinition')[]}
  */
  plugWhitelist;
  /**
  ...
  */
   ...
   * visible and enabled.
   * @readonly
   * @type {import('../../DestinySocketVisibility')}
  */
  visibility;
  /**
   * @readonly
  ...
  */
  ...
  /**
   * @readonly
   * @type {import('./DestinySocketTypeScalarMaterialRequirementEntry')[]}
  */
  currencyScalars;
  /**
