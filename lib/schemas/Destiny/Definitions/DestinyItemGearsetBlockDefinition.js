 ...
 * @property {number} trackingValueMax The maximum possible number of items that can be collected.
 * @property {number[]} itemList The list of hashes for items in the gearset. Use them to look up DestinyInventoryItemDefinition entries for the items in the set. Mapped to DestinyInventoryItemDefinition in the manifest.
...
module.exports = DestinyItemGearsetBlockDefinition;
