...
module.exports = class DestinyActivityGraphNodeDefinition {
  ...
  */
   ...
   * @readonly
   * @type {import('../Common/DestinyPositionDefinition')}
  */
  position;
  /**
   ...
   * in that style.
   * @readonly
   * @type {import('./DestinyActivityGraphNodeFeaturingStateDefinition')[]}
  */
  featuringStates;
  /**
   ...
   * @readonly
   * @type {import('./DestinyActivityGraphNodeActivityDefinition')[]}
  */
  activities;
  /**
   ...
   * @readonly
   * @type {import('./DestinyActivityGraphNodeStateEntry')[]}
  */
  states;
}
