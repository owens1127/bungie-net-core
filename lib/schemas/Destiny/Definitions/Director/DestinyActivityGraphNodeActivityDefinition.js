 ...
 * @property {number} nodeActivityId An identifier for this node activity. It is only guaranteed to be unique within the Activity Graph.
 * @property {number} activityHash The activity that will be activated if the user clicks on this node. Controls all activity-related information displayed on the node if it is active (the text shown in the tooltip etc) Mapped to DestinyActivityDefinition in the manifest.
...
module.exports = DestinyActivityGraphNodeActivityDefinition;
