...
module.exports = class DestinyActivityGraphDefinition {
   ...
   * @readonly
   * @type {import('./DestinyActivityGraphNodeDefinition')[]}
  */
  nodes;
  /**
   * Represents one-off/special UI elements that appear on the map.
   * @readonly
   * @type {import('./DestinyActivityGraphArtElementDefinition')[]}
  */
  artElements;
  /**
   ...
   * @readonly
   * @type {import('./DestinyActivityGraphConnectionDefinition')[]}
  */
  connections;
  /**
   ...
   * @readonly
   * @type {import('./DestinyActivityGraphDisplayObjectiveDefinition')[]}
  */
  displayObjectives;
  /**
   ...
   * @readonly
   * @type {import('./DestinyActivityGraphDisplayProgressionDefinition')[]}
  */
  displayProgressions;
  /**
   * Represents links between this Activity Graph and other ones.
   * @readonly
   * @type {import('./DestinyLinkedGraphDefinition')[]}
  */
  linkedGraphs;
  /**
