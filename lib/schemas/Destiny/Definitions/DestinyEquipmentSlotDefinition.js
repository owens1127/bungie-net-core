 ...
 * @property {number} equipmentCategoryHash These technically point to "Equipment Category Definitions". But don't get excited. There's nothing of significant value in those definitions, so I didn't bother to expose them. You can use the hash here to group equipment slots by common functionality, which serves the same purpose as if we had the Equipment Category definitions exposed.
 * @property {number} bucketTypeHash The inventory bucket that owns this equipment slot. Mapped to DestinyInventoryBucketDefinition in the manifest.
 * @property {boolean} applyCustomArtDyes If True, equipped items should have their custom art dyes applied when rendering the item. Otherwise, custom art dyes on an item should be ignored if the item is equipped in this slot.
 * @property {DestinyArtDyeReference[]} artDyeChannels The Art Dye Channels that apply to this equipment slot.
...
module.exports = DestinyEquipmentSlotDefinition;
