...
module.exports = class DestinyVendorInteractionDefinition {
  ...
  */
   ...
   * @readonly
   * @type {import('./DestinyVendorInteractionReplyDefinition')[]}
  */
  replies;
  /**
  ...
  */
   ...
   * @readonly
   * @type {import('./DestinyVendorInteractionSackEntryDefinition')[]}
  */
  sackInteractionList;
  /**
  ...
  */
   ...
   * @readonly
   * @type {import('../VendorInteractionType')}
  */
  interactionType;
  /**
