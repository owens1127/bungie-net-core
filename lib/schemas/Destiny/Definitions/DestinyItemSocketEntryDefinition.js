...
module.exports = class DestinyItemSocketEntryDefinition {
  ...
  */
   ...
   * @readonly
   * @type {import('./DestinyItemSocketEntryPlugItemDefinition')[]}
  */
  reusablePlugItems;
  /**
