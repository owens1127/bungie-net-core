...
/**
 * @type DestinyMetricDefinition
 * @property {DestinyDisplayPropertiesDefinition} displayProperties 
 * @property {number} trackingObjectiveHash Mapped to DestinyObjectiveDefinition in the manifest.
 * @property {boolean} lowerValueIsBetter 
...
module.exports = DestinyMetricDefinition;
