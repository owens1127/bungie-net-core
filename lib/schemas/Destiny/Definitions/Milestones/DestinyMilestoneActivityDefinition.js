...
module.exports = class DestinyMilestoneActivityDefinition {
  ...
  */
   ...
   * @readonly
   * @type {{[key: number]: DestinyMilestoneActivityVariantDefinition}}
  */
  variants;
}
