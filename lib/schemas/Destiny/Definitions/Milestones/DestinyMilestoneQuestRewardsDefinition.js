 ...
 * @type {typeof DestinyMilestoneQuestRewardsDefinition}
...
*/
module.exports = class DestinyMilestoneQuestRewardsDefinition {
  /**
   ...
   * @readonly
   * @type {import('./DestinyMilestoneQuestRewardItem')[]}
  */
  items;
}
