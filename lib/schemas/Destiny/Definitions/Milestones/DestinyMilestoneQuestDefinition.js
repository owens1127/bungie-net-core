...
module.exports = class DestinyMilestoneQuestDefinition {
  ...
  */
   ...
   * @readonly
   * @type import('./DestinyMilestoneQuestRewardsDefinition')
  */
  questRewards;
  /**
   ...
   * the manifest.
   * @readonly
   * @type {{[key: number]: DestinyMilestoneActivityDefinition}}
  */
  activities;
  /**
