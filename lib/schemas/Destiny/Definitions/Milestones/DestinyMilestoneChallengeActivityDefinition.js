...
/**
 * @type {typeof DestinyMilestoneChallengeActivityDefinition}
...
*/
module.exports = class DestinyMilestoneChallengeActivityDefinition {
  /**
  ...
  */
  ...
  /**
   * @readonly
   * @type import('./DestinyMilestoneChallengeDefinition')[]
  */
  challenges;
  /**
   ...
   * returned.
   * @readonly
   * @type import('./DestinyMilestoneChallengeActivityGraphNodeEntry')[]
  */
  activityGraphNodes;
  /**
   ...
   * activity.
   * @readonly
   * @type import('./DestinyMilestoneChallengeActivityPhase')[]
  */
  phases;
}
