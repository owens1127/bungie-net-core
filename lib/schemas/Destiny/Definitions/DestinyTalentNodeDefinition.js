...
module.exports = class DestinyTalentNodeDefinition {
  ...
  */
   ...
   * below.
   * @readonly
   * @type {import('./DestinyNodeStepDefinition')[]}
  */
  steps;
  /**
  ...
  */
   ...
   * one to be show. Mapped to DestinyLoreDefinition in the manifest.
   * @readonly
   * @type {number}
  */
  loreHash;
