 ...
 * @property {number} sortPriority Apparently when rendering an item in a reward, this should be used as a sort priority. We're not doing it presently.
...
module.exports = DestinyItemSummaryBlockDefinition;
