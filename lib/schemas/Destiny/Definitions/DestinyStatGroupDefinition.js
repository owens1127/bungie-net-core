...
module.exports = class DestinyStatGroupDefinition {
  ...
  */
   ...
   * @readonly
   * @type import('./DestinyStatDisplayDefinition')[]
  */
  scaledStats;
  /**
   ...
   * @readonly
   * @type {{[key: number]: DestinyStatOverrideDefinition}}
  */
  overrides;
  /**
