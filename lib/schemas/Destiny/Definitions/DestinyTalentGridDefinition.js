...
module.exports = class DestinyTalentGridDefinition {
  ...
  */
   ...
   * @readonly
   * @type import('./DestinyTalentNodeDefinition')[]
  */
  nodes;
  /**
   ...
   * @readonly
   * @type import('./DestinyTalentNodeExclusiveSetDefinition')[]
  */
  exclusiveSets;
  /**
  ...
  */
   ...
   * @readonly
   * @type {{[key: number]: DestinyTalentExclusiveGroup}}
  */
  groups;
  /**
   ...
   * grouping.
   * @readonly
   * @type import('./DestinyTalentNodeCategory')[]
  */
  nodeCategories;
  /**
