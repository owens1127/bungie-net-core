 ...
 * @property {string} traitCategoryId 
 * @property {number} traitCategoryHash Mapped to DestinyTraitCategoryDefinition in the manifest.
 * @property {string} displayHint An identifier for how this trait can be displayed. For example: a 'keyword' hint to show an explanation for certain related terms.
