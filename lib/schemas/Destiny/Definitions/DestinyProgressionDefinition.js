 ...
 * about those.
 * @type {typeof DestinyProgressionDefinition}
 * @see {@link https://bungie-net.github.io/#/components/schemas/Destiny.Definitions.DestinyProgressionDefinition}
*/
module.exports = class DestinyProgressionDefinition {
  /**
   * @readonly
   * @type import('./DestinyProgressionDisplayPropertiesDefinition')
  */
  displayProperties;
  /**
   ...
   * @readonly
   * @type import('../DestinyProgressionScope')
  */
  scope;
  /**
  ...
  */
   ...
   * @readonly
   * @type import('./DestinyProgressionStepDefinition')[]
  */
  steps;
  /**
  ...
  */
  ...
  /**
   * @readonly
   * @type import('./DestinyProgressionRewardItemQuantity')[]
  */
  rewardItems;
  /**
