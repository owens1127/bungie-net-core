 ...
 * @type DestinyProgressionLevelRequirementDefinition
 * @property {InterpolationPointFloat[]} requirementCurve A curve of level requirements, weighted by the related progressions' level.
 ...
 * @property {number} progressionHash The progression whose level should be used to determine the level requirement.
Look up the DestinyProgressionDefinition with this hash for more information about the progression in question. Mapped to DestinyProgressionDefinition in the manifest.
...
module.exports = DestinyProgressionLevelRequirementDefinition;
