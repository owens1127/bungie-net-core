 ...
 * @type {typeof DestinyProgressionLevelRequirementDefinition}
...
*/
module.exports = class DestinyProgressionLevelRequirementDefinition {
  /**
   ...
   * data will be.
   * @readonly
   * @type {import('../../../Interpolation/InterpolationPointFloat')[]}
  */
  requirementCurve;
  /**
