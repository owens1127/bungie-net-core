...
module.exports = class DestinyItemPlugDefinition {
   ...
   * @readonly
   * @type {import('./DestinyPlugRuleDefinition')[]}
  */
  insertionRules;
  /**
  ...
  */
   ...
   * @readonly
   * @type {import('../../PlugAvailabilityMode')}
  */
  plugAvailability;
  /**
  ...
  */
   ...
   * @readonly
   * @type {import('./DestinyParentItemOverride')}
  */
  parentItemOverride;
  /**
   ...
   * @readonly
   * @type {import('./DestinyEnergyCapacityEntry')}
  */
  energyCapacity;
  /**
   ...
   * cost.
   * @readonly
   * @type {import('./DestinyEnergyCostEntry')}
  */
  energyCost;
}
