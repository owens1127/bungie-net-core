 ...
 * @property {number} socketTypeHash The hash identifier of the socket type to find amidst the item's sockets (the item to which this talent grid is attached). See DestinyInventoryItemDefinition.sockets.socketEntries to find the socket type of sockets on the item in question. Mapped to DestinySocketTypeDefinition in the manifest.
 * @property {number} plugItemHash The hash identifier of the plug item that will be inserted into the socket found. Mapped to DestinyInventoryItemDefinition in the manifest.
