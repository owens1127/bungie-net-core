...
module.exports = class DestinyItemCraftingBlockDefinition {
  ...
  */
   ...
   * met.
   * @readonly
   * @type {import('./DestinyItemCraftingBlockBonusPlugDefinition')[]}
  */
  bonusPlugs;
}
