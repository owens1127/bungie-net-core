 ...
 * @property {number} statHash The hash for the DestinyStatDefinition representing this stat. Mapped to DestinyStatDefinition in the manifest.
 * @property {number} value This value represents the stat value assuming the minimum possible roll but accounting for any mandatory bonuses that should be applied to the stat on item creation.
 ...
 * @property {number} minimum The minimum possible value for this stat that we think the item can roll.
 * @property {number} maximum The maximum possible value for this stat that we think the item can roll.
 ...
 * @property {number?} displayMaximum The maximum possible value for the stat as shown in the UI, if it is being shown somewhere that reveals maximum in the UI (such as a bar chart-style view).
...
module.exports = DestinyInventoryItemStatDefinition;
