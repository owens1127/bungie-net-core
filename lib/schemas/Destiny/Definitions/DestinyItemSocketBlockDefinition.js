...
module.exports = class DestinyItemSocketBlockDefinition {
  ...
  */
   ...
   * for more info.
   * @readonly
   * @type {import('./DestinyItemSocketEntryDefinition')[]}
  */
  socketEntries;
  /**
   ...
   * @readonly
   * @type {import('./DestinyItemIntrinsicSocketEntryDefinition')[]}
  */
  intrinsicSockets;
  /**
   ...
   * @readonly
   * @type {import('./DestinyItemSocketCategoryDefinition')[]}
  */
  socketCategories;
}
