export let DestinyActivityDifficultyTier;
(function (DestinyActivityDifficultyTier) {
    DestinyActivityDifficultyTier[
        (DestinyActivityDifficultyTier['Trivial'] = 0)
    ] = 'Trivial';
    DestinyActivityDifficultyTier[(DestinyActivityDifficultyTier['Easy'] = 1)] =
        'Easy';
    DestinyActivityDifficultyTier[
    ...
    DestinyActivityDifficultyTier[(DestinyActivityDifficultyTier['Hard'] = 4)] =
        'Hard';
    DestinyActivityDifficultyTier[
...
})(DestinyActivityDifficultyTier || (DestinyActivityDifficultyTier = {}));
