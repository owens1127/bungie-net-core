...
/**
 * @typedef {number | DestinyItemType.None | DestinyItemType.Currency | DestinyItemType.Armor | DestinyItemType.Weapon | DestinyItemType.Message | DestinyItemType.Engram | DestinyItemType.Consumable | DestinyItemType.ExchangeMaterial | DestinyItemType.MissionReward | DestinyItemType.QuestStep | DestinyItemType.QuestStepComplete | DestinyItemType.Emblem | DestinyItemType.Quest | DestinyItemType.Subclass | DestinyItemType.ClanBanner | DestinyItemType.Aura | DestinyItemType.Mod | DestinyItemType.Dummy | DestinyItemType.Ship | DestinyItemType.Vehicle | DestinyItemType.Emote | DestinyItemType.Ghost | DestinyItemType.Package | DestinyItemType.Bounty | DestinyItemType.Wrapper | DestinyItemType.SeasonalArtifact | DestinyItemType.Finisher | DestinyItemType.Pattern} DestinyItemType
 ...
 * @see {@link https://bungie-net.github.io/#/components/schemas/Destiny.DestinyItemType}
*/
const DestinyItemType = Object.freeze({
  None: 0,
  Currency: 1,
  Armor: 2,
  Weapon: 3,
...
module.exports = DestinyItemType
