...
/**
 * @typedef {number | DestinyComponentType.None | DestinyComponentType.Profiles | DestinyComponentType.VendorReceipts | DestinyComponentType.ProfileInventories | DestinyComponentType.ProfileCurrencies | DestinyComponentType.ProfileProgression | DestinyComponentType.PlatformSilver | DestinyComponentType.Characters | DestinyComponentType.CharacterInventories | DestinyComponentType.CharacterProgressions | DestinyComponentType.CharacterRenderData | DestinyComponentType.CharacterActivities | DestinyComponentType.CharacterEquipment | DestinyComponentType.ItemInstances | DestinyComponentType.ItemObjectives | DestinyComponentType.ItemPerks | DestinyComponentType.ItemRenderData | DestinyComponentType.ItemStats | DestinyComponentType.ItemSockets | DestinyComponentType.ItemTalentGrids | DestinyComponentType.ItemCommonData | DestinyComponentType.ItemPlugStates | DestinyComponentType.ItemPlugObjectives | DestinyComponentType.ItemReusablePlugs | DestinyComponentType.Vendors | DestinyComponentType.VendorCategories | DestinyComponentType.VendorSales | DestinyComponentType.Kiosks | DestinyComponentType.CurrencyLookups | DestinyComponentType.PresentationNodes | DestinyComponentType.Collectibles | DestinyComponentType.Records | DestinyComponentType.Transitory | DestinyComponentType.Metrics | DestinyComponentType.StringVariables | DestinyComponentType.Craftables} DestinyComponentType
 ...
 * @see {@link https://bungie-net.github.io/#/components/schemas/Destiny.DestinyComponentType}
*/
const DestinyComponentType = Object.freeze({
  None: 0,
  /**
...
module.exports = DestinyComponentType
