...
module.exports = class DestinyFactionProgression {
  ...
  */
   ...
   * for it.
   * @readonly
   * @type import('../DestinyProgressionResetEntry')[]
  */
  seasonResets;
  /**
   ...
   * for it.
   * @readonly
   * @type import('../DestinyProgressionRewardItemState')[]
  */
  rewardItemStates;
}
