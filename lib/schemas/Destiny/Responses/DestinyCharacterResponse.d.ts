...
export interface DestinyCharacterResponse<T extends DestinyComponentType[]> extends ComponentData {
    ...
    */
    readonly inventory: ConditionalComponent<T, DestinyComponentType.CharacterInventories, SingleComponentResponse<DestinyInventoryComponent>>;
    /**
     * Base information about the character in question.
     *
     * COMPONENT TYPE: Characters
    */
    readonly character: ConditionalComponent<T, DestinyComponentType.Characters, SingleComponentResponse<DestinyCharacterComponent>>;
    /**
     * Character progression data, including Milestones.
     *
     * COMPONENT TYPE: CharacterProgressions
    */
    readonly progressions: ConditionalComponent<T, DestinyComponentType.CharacterProgressions, SingleComponentResponse<DestinyCharacterProgressionComponent>>;
    /**
    ...
    */
    readonly renderData: ConditionalComponent<T, DestinyComponentType.CharacterRenderData, SingleComponentResponse<DestinyCharacterRenderComponent>>;
    /**
     * Activity data - info about current activities available to the player.
     *
     * COMPONENT TYPE: CharacterActivities
    */
    readonly activities: ConditionalComponent<T, DestinyComponentType.CharacterActivities, SingleComponentResponse<DestinyCharacterActivitiesComponent>>;
    /**
     * Equipped items on the character.
     *
     * COMPONENT TYPE: CharacterEquipment
    */
    readonly equipment: ConditionalComponent<T, DestinyComponentType.CharacterEquipment, SingleComponentResponse<DestinyInventoryComponent>>;
    /**
     * The loadouts available to the character.
     *
     * COMPONENT TYPE: CharacterLoadouts
    */
    readonly loadouts: ConditionalComponent<T, DestinyComponentType.CharacterLoadouts, SingleComponentResponse<DestinyLoadoutsComponent>>;
    /**
     * Items available from Kiosks that are available to this specific character.
     *
     * COMPONENT TYPE: Kiosks
    */
    readonly kiosks: ConditionalComponent<T, DestinyComponentType.Kiosks, SingleComponentResponse<DestinyKiosksComponent>>;
    /**
    ...
    */
    readonly plugSets: ConditionalComponent<T, DestinyComponentType.ItemSockets, SingleComponentResponse<DestinyPlugSetsComponent>>;
    /** COMPONENT TYPE: PresentationNodes */
    readonly presentationNodes: ConditionalComponent<T, DestinyComponentType.PresentationNodes, SingleComponentResponse<DestinyPresentationNodesComponent>>;
    /** COMPONENT TYPE: Records */
    readonly records: ConditionalComponent<T, DestinyComponentType.Records, SingleComponentResponse<DestinyCharacterRecordsComponent>>;
