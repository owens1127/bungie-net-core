...
module.exports = class DestinyPublicVendorsResponse {
   ...
   * @readonly
   * @type {import('../../SingleComponentResponseOfDestinyVendorGroupComponent')}
  */
  vendorGroups;
  /**
   ...
   * COMPONENT TYPE: Vendors
   * @readonly
   * @type {import('../../DictionaryComponentResponseOfuint32AndDestinyPublicVendorComponent')}
  */
  vendors;
  /**
   ...
   * @readonly
   * @type {import('../../DictionaryComponentResponseOfuint32AndDestinyVendorCategoriesComponent')}
  */
  categories;
  /**
   ...
   * @readonly
   * @type {import('../../DictionaryComponentResponseOfuint32AndPublicDestinyVendorSaleItemSetComponent')}
  */
  sales;
  /**
