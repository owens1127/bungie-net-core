...
module.exports = class DestinyVendorsResponse {
  ...
  */
   ...
   * COMPONENT TYPE: Vendors
   * @readonly
   * @type {import('../../DictionaryComponentResponseOfuint32AndDestinyVendorComponent')}
  */
  vendors;
  /**
  ...
  */
   ...
   * @readonly
   * @type {import('../../DictionaryComponentResponseOfuint32AndPersonalDestinyVendorSaleItemSetComponent')}
  */
  sales;
  /**
