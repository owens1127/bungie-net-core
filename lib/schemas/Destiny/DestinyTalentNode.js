...
module.exports = class DestinyTalentNode {
  ...
  */
   ...
   * @readonly
   * @type {import('./DestinyTalentNodeState')}
  */
  state;
  /**
  ...
  */
   ...
   * requirements.
   * @readonly
   * @type {import('./Definitions/DestinyMaterialRequirement')[]}
  */
  materialsToUpgrade;
  /**
  ...
  */
   ...
   * those stat bonuses.
   * @readonly
   * @type {import('./DestinyTalentNodeStatBlock')}
  */
  nodeStatsBlock;
}
