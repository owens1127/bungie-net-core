...
/**
 * @typedef {number | SpecialItemType.None | SpecialItemType.SpecialCurrency | SpecialItemType.Armor | SpecialItemType.Weapon | SpecialItemType.Engram | SpecialItemType.Consumable | SpecialItemType.ExchangeMaterial | SpecialItemType.MissionReward | SpecialItemType.Currency} SpecialItemType
 ...
 * @see {@link https://bungie-net.github.io/#/components/schemas/Destiny.SpecialItemType}
*/
const SpecialItemType = Object.freeze({
  None: 0,
  SpecialCurrency: 1,
  Armor: 8,
  Weapon: 9,
...
module.exports = SpecialItemType
