...
/**
 * @typedef {number | DestinyItemSubType.None | DestinyItemSubType.Crucible | DestinyItemSubType.Vanguard | DestinyItemSubType.Exotic | DestinyItemSubType.AutoRifle | DestinyItemSubType.Shotgun | DestinyItemSubType.Machinegun | DestinyItemSubType.HandCannon | DestinyItemSubType.RocketLauncher | DestinyItemSubType.FusionRifle | DestinyItemSubType.SniperRifle | DestinyItemSubType.PulseRifle | DestinyItemSubType.ScoutRifle | DestinyItemSubType.Crm | DestinyItemSubType.Sidearm | DestinyItemSubType.Sword | DestinyItemSubType.Mask | DestinyItemSubType.Shader | DestinyItemSubType.Ornament | DestinyItemSubType.FusionRifleLine | DestinyItemSubType.GrenadeLauncher | DestinyItemSubType.SubmachineGun | DestinyItemSubType.TraceRifle | DestinyItemSubType.HelmetArmor | DestinyItemSubType.GauntletsArmor | DestinyItemSubType.ChestArmor | DestinyItemSubType.LegArmor | DestinyItemSubType.ClassArmor | DestinyItemSubType.Bow | DestinyItemSubType.DummyRepeatableBounty | DestinyItemSubType.Glaive} DestinyItemSubType
 ...
 * @see {@link https://bungie-net.github.io/#/components/schemas/Destiny.DestinyItemSubType}
*/
const DestinyItemSubType = Object.freeze({
  None: 0,
...
module.exports = DestinyItemSubType
