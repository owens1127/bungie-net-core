...
(function (DestinyItemSubType) {
    ...
    DestinyItemSubType[(DestinyItemSubType['RocketLauncher'] = 10)] =
        'RocketLauncher';
    DestinyItemSubType[(DestinyItemSubType['FusionRifle'] = 11)] =
        'FusionRifle';
    DestinyItemSubType[(DestinyItemSubType['SniperRifle'] = 12)] =
        'SniperRifle';
    ...
    DestinyItemSubType[(DestinyItemSubType['FusionRifleLine'] = 22)] =
        'FusionRifleLine';
    DestinyItemSubType[(DestinyItemSubType['GrenadeLauncher'] = 23)] =
        'GrenadeLauncher';
    DestinyItemSubType[(DestinyItemSubType['SubmachineGun'] = 24)] =
        'SubmachineGun';
    DestinyItemSubType[(DestinyItemSubType['TraceRifle'] = 25)] = 'TraceRifle';
    DestinyItemSubType[(DestinyItemSubType['HelmetArmor'] = 26)] =
        'HelmetArmor';
    DestinyItemSubType[(DestinyItemSubType['GauntletsArmor'] = 27)] =
        'GauntletsArmor';
    ...
    DestinyItemSubType[(DestinyItemSubType['DummyRepeatableBounty'] = 32)] =
