...
/**
 * @typedef {number | DestinyGatingScope.None | DestinyGatingScope.Global | DestinyGatingScope.Clan | DestinyGatingScope.Profile | DestinyGatingScope.Character | DestinyGatingScope.Item | DestinyGatingScope.AssumedWorstCase} DestinyGatingScope
 ...
 * @see {@link https://bungie-net.github.io/#/components/schemas/Destiny.DestinyGatingScope}
*/
const DestinyGatingScope = Object.freeze({
  None: 0,
  Global: 1,
  Clan: 2,
  Profile: 3,
...
module.exports = DestinyGatingScope
