...
module.exports = class DestinyMilestoneQuest {
  ...
  */
   ...
   * @readonly
   * @type {import('./DestinyMilestoneActivity')}
  */
  activity;
  /**
   ...
   * revision.
   * @readonly
   * @type {import('../Challenges/DestinyChallengeStatus')[]}
  */
  challenges;
}
