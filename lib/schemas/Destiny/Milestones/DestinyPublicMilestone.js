...
module.exports = class DestinyPublicMilestone {
  ...
  */
   ...
   * @readonly
   * @type {import('./DestinyPublicMilestoneQuest')[]}
  */
  availableQuests;
  /**
   * @readonly
   * @type {import('./DestinyPublicMilestoneChallengeActivity')[]}
  */
  activities;
  /**
  ...
  */
   ...
   * data.
   * @readonly
   * @type {import('./DestinyPublicMilestoneVendor')[]}
  */
  vendors;
  /**
