...
module.exports = class DestinyPublicMilestoneQuest {
  ...
  */
   ...
   * @readonly
   * @type import('./DestinyPublicMilestoneActivity')
  */
  activity;
  /**
   ...
   * benefits.
   * @readonly
   * @type import('./DestinyPublicMilestoneChallenge')[]
  */
  challenges;
}
