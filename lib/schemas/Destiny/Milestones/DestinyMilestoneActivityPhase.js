 ...
 * @property {boolean} complete Indicates if the phase has been completed.
 * @property {number} phaseHash In DestinyActivityDefinition, if the activity has phases, there will be a set of phases defined in the "insertionPoints" property. This is the hash that maps to that phase.
...
module.exports = DestinyMilestoneActivityPhase;
