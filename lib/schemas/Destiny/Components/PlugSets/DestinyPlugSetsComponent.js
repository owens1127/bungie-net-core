 ...
 * @property {Object.key<number, DestinyItemPlug[]>} plugs The shared list of plugs for each relevant PlugSet, keyed by the hash identifier of the PlugSet (DestinyPlugSetDefinition). Mapped to DestinyPlugSetDefinition in the manifest.
...
module.exports = DestinyPlugSetsComponent;
