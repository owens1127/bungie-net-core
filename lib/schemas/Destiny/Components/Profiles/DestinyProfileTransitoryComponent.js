 ...
 * @property {DestinyProfileTransitoryPartyMember[]} partyMembers If you have any members currently in your party, this is some (very) bare-bones information about those members.
 * @property {DestinyProfileTransitoryCurrentActivity} currentActivity If you are in an activity, this is some transitory info about the activity currently being played.
 * @property {DestinyProfileTransitoryJoinability} joinability Information about whether and what might prevent you from joining this person on a fireteam.
 * @property {DestinyProfileTransitoryTrackingEntry[]} tracking Information about tracked entities.
 * @property {number?} lastOrbitedDestinationHash The hash identifier for the DestinyDestinationDefinition of the last location you were orbiting when in orbit. Mapped to DestinyDestinationDefinition in the manifest.
...
module.exports = DestinyProfileTransitoryComponent;
