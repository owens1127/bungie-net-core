...
module.exports = class DestinyProfileTransitoryComponent {
  ...
  */
   ...
   * @readonly
   * @type import('./DestinyProfileTransitoryCurrentActivity')
  */
  currentActivity;
  /**
   ...
   * a fireteam.
   * @readonly
   * @type import('./DestinyProfileTransitoryJoinability')
  */
  joinability;
  /**
   * Information about tracked entities.
   * @readonly
   * @type import('./DestinyProfileTransitoryTrackingEntry')[]
  */
  tracking;
  /**
