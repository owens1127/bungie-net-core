...
module.exports = class DestinyProfileProgressionComponent {
  ...
  */
   ...
   * across characters.
   * @readonly
   * @type {import('../../Artifacts/DestinyArtifactProfileScoped')}
  */
  seasonalArtifact;
}
