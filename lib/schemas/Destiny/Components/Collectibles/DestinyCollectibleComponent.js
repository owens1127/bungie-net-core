 ...
 * @property {DestinyCollectibleState} state This enum represents a set of flags - use bitwise operators to check which of these match your value.
...
module.exports = DestinyCollectibleComponent;
