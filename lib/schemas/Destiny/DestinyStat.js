 ...
 * @type DestinyStat
 * @property {number} statHash The hash identifier for the Stat. Use it to look up the DestinyStatDefinition for static data about the stat. Mapped to DestinyStatDefinition in the manifest.
