...
function getActivePrivateClanFireteamCount(_x, _x2) {
  return _getActivePrivateClanFireteamCount.apply(this, arguments);
}
function _getActivePrivateClanFireteamCount() {
  _getActivePrivateClanFireteamCount = _asyncToGenerator(function* (params) {
    var _access_token;
