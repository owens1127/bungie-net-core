...
function getAvailableClanFireteams(_x, _x2) {
  return _getAvailableClanFireteams.apply(this, arguments);
}
function _getAvailableClanFireteams() {
  _getAvailableClanFireteams = _asyncToGenerator(function* (params) {
    var _access_token;
