...
function searchPublicAvailableClanFireteams(_x, _x2) {
  return _searchPublicAvailableClanFireteams.apply(this, arguments);
}
function _searchPublicAvailableClanFireteams() {
  _searchPublicAvailableClanFireteams = _asyncToGenerator(function* (params) {
    var _access_token;
