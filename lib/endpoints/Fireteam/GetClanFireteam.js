...
function getClanFireteam(_x, _x2) {
  return _getClanFireteam.apply(this, arguments);
}
function _getClanFireteam() {
  _getClanFireteam = _asyncToGenerator(function* (params) {
    var _access_token;
