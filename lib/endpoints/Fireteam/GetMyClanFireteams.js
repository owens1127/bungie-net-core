...
function getMyClanFireteams(_x, _x2) {
  return _getMyClanFireteams.apply(this, arguments);
}
function _getMyClanFireteams() {
  _getMyClanFireteams = _asyncToGenerator(function* (params) {
    var _access_token;
