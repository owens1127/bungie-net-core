...
function issueFriendRequest(_x, _x2) {
  return _issueFriendRequest.apply(this, arguments);
}
function _issueFriendRequest() {
  _issueFriendRequest = _asyncToGenerator(function* (params) {
    var _access_token;
