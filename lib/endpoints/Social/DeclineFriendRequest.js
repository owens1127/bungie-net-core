...
function declineFriendRequest(_x, _x2) {
  return _declineFriendRequest.apply(this, arguments);
}
function _declineFriendRequest() {
  _declineFriendRequest = _asyncToGenerator(function* (params) {
    var _access_token;
