...
function getPlatformFriendList(_x, _x2) {
  return _getPlatformFriendList.apply(this, arguments);
}
function _getPlatformFriendList() {
  _getPlatformFriendList = _asyncToGenerator(function* (params) {
    var _access_token;
