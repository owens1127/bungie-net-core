...
function getFriendRequestList(_x) {
  return _getFriendRequestList.apply(this, arguments);
}
function _getFriendRequestList() {
  _getFriendRequestList = _asyncToGenerator(function* () {
    var _access_token;
