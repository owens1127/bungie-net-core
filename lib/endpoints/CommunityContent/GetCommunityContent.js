...
function getCommunityContent(_x, _x2) {
  return _getCommunityContent.apply(this, arguments);
}
function _getCommunityContent() {
  _getCommunityContent = _asyncToGenerator(function* (params) {
    var _access_token;
