...
exports.getGlobalAlerts = getGlobalAlerts;
...
function getGlobalAlerts(_x, _x2) {
  return _getGlobalAlerts.apply(this, arguments);
}
function _getGlobalAlerts() {
  _getGlobalAlerts = _asyncToGenerator(function* (params) {
    var _access_token;
