...
exports.getCommonSettings = getCommonSettings;
...
function getCommonSettings(_x) {
  return _getCommonSettings.apply(this, arguments);
}
function _getCommonSettings() {
  _getCommonSettings = _asyncToGenerator(function* () {
    var _access_token;
