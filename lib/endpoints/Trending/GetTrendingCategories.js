...
function getTrendingCategories(_x) {
  return _getTrendingCategories.apply(this, arguments);
}
function _getTrendingCategories() {
  _getTrendingCategories = _asyncToGenerator(function* () {
    var _access_token;
