...
function getTrendingEntryDetail(_x, _x2) {
  return _getTrendingEntryDetail.apply(this, arguments);
}
function _getTrendingEntryDetail() {
  _getTrendingEntryDetail = _asyncToGenerator(function* (params) {
    var _access_token;
