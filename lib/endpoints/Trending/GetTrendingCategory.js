...
function getTrendingCategory(_x, _x2) {
  return _getTrendingCategory.apply(this, arguments);
}
function _getTrendingCategory() {
  _getTrendingCategory = _asyncToGenerator(function* (params) {
    var _access_token;
