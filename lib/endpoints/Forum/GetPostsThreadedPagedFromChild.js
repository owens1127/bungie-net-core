...
function getPostsThreadedPagedFromChild(_x, _x2) {
  return _getPostsThreadedPagedFromChild.apply(this, arguments);
}
function _getPostsThreadedPagedFromChild() {
  _getPostsThreadedPagedFromChild = _asyncToGenerator(function* (params) {
    var _access_token;
