...
function getPostAndParent(_x, _x2) {
  return _getPostAndParent.apply(this, arguments);
}
function _getPostAndParent() {
  _getPostAndParent = _asyncToGenerator(function* (params) {
    var _access_token;
