...
function getRecruitmentThreadSummaries(_x, _x2) {
  return _getRecruitmentThreadSummaries.apply(this, arguments);
}
function _getRecruitmentThreadSummaries() {
  _getRecruitmentThreadSummaries = _asyncToGenerator(function* (body) {
    var _access_token;
