...
function getCoreTopicsPaged(_x, _x2) {
  return _getCoreTopicsPaged.apply(this, arguments);
}
function _getCoreTopicsPaged() {
  _getCoreTopicsPaged = _asyncToGenerator(function* (params) {
    var _access_token;
