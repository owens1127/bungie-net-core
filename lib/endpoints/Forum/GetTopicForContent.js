...
function getTopicForContent(_x, _x2) {
  return _getTopicForContent.apply(this, arguments);
}
function _getTopicForContent() {
  _getTopicForContent = _asyncToGenerator(function* (params) {
    var _access_token;
