...
function getPostAndParentAwaitingApproval(_x, _x2) {
  return _getPostAndParentAwaitingApproval.apply(this, arguments);
}
function _getPostAndParentAwaitingApproval() {
  _getPostAndParentAwaitingApproval = _asyncToGenerator(function* (params) {
    var _access_token;
