...
function getForumTagSuggestions(_x, _x2) {
  return _getForumTagSuggestions.apply(this, arguments);
}
function _getForumTagSuggestions() {
  _getForumTagSuggestions = _asyncToGenerator(function* (params) {
    var _access_token;
