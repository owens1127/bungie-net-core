...
function getPostsThreadedPaged(_x, _x2) {
  return _getPostsThreadedPaged.apply(this, arguments);
}
function _getPostsThreadedPaged() {
  _getPostsThreadedPaged = _asyncToGenerator(function* (params) {
    var _access_token;
