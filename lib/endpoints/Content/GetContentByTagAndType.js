...
function getContentByTagAndType(_x, _x2) {
  return _getContentByTagAndType.apply(this, arguments);
}
function _getContentByTagAndType() {
  _getContentByTagAndType = _asyncToGenerator(function* (params) {
    var _access_token;
