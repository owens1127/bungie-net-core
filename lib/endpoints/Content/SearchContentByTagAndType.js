...
function searchContentByTagAndType(_x, _x2) {
  return _searchContentByTagAndType.apply(this, arguments);
}
function _searchContentByTagAndType() {
  _searchContentByTagAndType = _asyncToGenerator(function* (params) {
    var _access_token;
