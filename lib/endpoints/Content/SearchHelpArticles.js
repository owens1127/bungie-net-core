...
function searchHelpArticles(_x, _x2) {
  return _searchHelpArticles.apply(this, arguments);
}
function _searchHelpArticles() {
  _searchHelpArticles = _asyncToGenerator(function* (params) {
    var _access_token;
