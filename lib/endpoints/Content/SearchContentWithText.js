...
function searchContentWithText(_x, _x2) {
  return _searchContentWithText.apply(this, arguments);
}
function _searchContentWithText() {
  _searchContentWithText = _asyncToGenerator(function* (params) {
    var _access_token;
