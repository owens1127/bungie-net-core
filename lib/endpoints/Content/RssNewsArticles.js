...
function rssNewsArticles(_x, _x2) {
  return _rssNewsArticles.apply(this, arguments);
}
function _rssNewsArticles() {
  _rssNewsArticles = _asyncToGenerator(function* (params) {
    var _access_token;
