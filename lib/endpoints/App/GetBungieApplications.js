...
function getBungieApplications(_x) {
  return _getBungieApplications.apply(this, arguments);
}
function _getBungieApplications() {
  _getBungieApplications = _asyncToGenerator(function* () {
    var _access_token;
