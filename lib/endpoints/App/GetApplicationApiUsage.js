...
function getApplicationApiUsage(_x, _x2) {
  return _getApplicationApiUsage.apply(this, arguments);
}
function _getApplicationApiUsage() {
  _getApplicationApiUsage = _asyncToGenerator(function* (params) {
    var _access_token;
