...
function denyAllPending(_x, _x2, _x3) {
  return _denyAllPending.apply(this, arguments);
}
function _denyAllPending() {
  _denyAllPending = _asyncToGenerator(function* (params, body) {
    var _access_token;
