...
function getBannedMembersOfGroup(_x, _x2) {
  return _getBannedMembersOfGroup.apply(this, arguments);
}
function _getBannedMembersOfGroup() {
  _getBannedMembersOfGroup = _asyncToGenerator(function* (params) {
    var _access_token;
