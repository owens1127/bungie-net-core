...
function recoverGroupForFounder(_x, _x2) {
  return _recoverGroupForFounder.apply(this, arguments);
}
function _recoverGroupForFounder() {
  _recoverGroupForFounder = _asyncToGenerator(function* (params) {
    var _access_token;
