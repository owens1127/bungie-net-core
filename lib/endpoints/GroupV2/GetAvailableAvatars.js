...
function getAvailableAvatars(_x) {
  return _getAvailableAvatars.apply(this, arguments);
}
function _getAvailableAvatars() {
  _getAvailableAvatars = _asyncToGenerator(function* () {
    var _access_token;
