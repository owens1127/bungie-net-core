...
function editFounderOptions(_x, _x2, _x3) {
  return _editFounderOptions.apply(this, arguments);
}
function _editFounderOptions() {
  _editFounderOptions = _asyncToGenerator(function* (params, body) {
    var _access_token;
