...
function getUserClanInviteSetting(_x, _x2) {
  return _getUserClanInviteSetting.apply(this, arguments);
}
function _getUserClanInviteSetting() {
  _getUserClanInviteSetting = _asyncToGenerator(function* (params) {
    var _access_token;
