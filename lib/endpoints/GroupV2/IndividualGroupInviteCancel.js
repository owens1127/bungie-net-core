...
function individualGroupInviteCancel(_x, _x2) {
  return _individualGroupInviteCancel.apply(this, arguments);
}
function _individualGroupInviteCancel() {
  _individualGroupInviteCancel = _asyncToGenerator(function* (params) {
    var _access_token;
