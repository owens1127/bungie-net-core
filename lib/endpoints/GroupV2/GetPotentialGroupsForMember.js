...
function getPotentialGroupsForMember(_x, _x2) {
  return _getPotentialGroupsForMember.apply(this, arguments);
}
function _getPotentialGroupsForMember() {
  _getPotentialGroupsForMember = _asyncToGenerator(function* (params) {
    var _access_token;
