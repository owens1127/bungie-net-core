...
function getRecommendedGroups(_x, _x2) {
  return _getRecommendedGroups.apply(this, arguments);
}
function _getRecommendedGroups() {
  _getRecommendedGroups = _asyncToGenerator(function* (params) {
    var _access_token;
