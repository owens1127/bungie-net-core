...
function editGroupMembership(_x, _x2) {
  return _editGroupMembership.apply(this, arguments);
}
function _editGroupMembership() {
  _editGroupMembership = _asyncToGenerator(function* (params) {
    var _access_token;
