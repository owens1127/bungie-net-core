...
function getInvitedIndividuals(_x, _x2) {
  return _getInvitedIndividuals.apply(this, arguments);
}
function _getInvitedIndividuals() {
  _getInvitedIndividuals = _asyncToGenerator(function* (params) {
    var _access_token;
