...
function getMembersOfGroup(_x, _x2) {
  return _getMembersOfGroup.apply(this, arguments);
}
function _getMembersOfGroup() {
  _getMembersOfGroup = _asyncToGenerator(function* (params) {
    var _access_token;
