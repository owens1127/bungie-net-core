...
function individualGroupInvite(_x, _x2, _x3) {
  return _individualGroupInvite.apply(this, arguments);
}
function _individualGroupInvite() {
  _individualGroupInvite = _asyncToGenerator(function* (params, body) {
    var _access_token;
