...
function getAdminsAndFounderOfGroup(_x, _x2) {
  return _getAdminsAndFounderOfGroup.apply(this, arguments);
}
function _getAdminsAndFounderOfGroup() {
  _getAdminsAndFounderOfGroup = _asyncToGenerator(function* (params) {
    var _access_token;
