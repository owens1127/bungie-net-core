...
function getPendingMemberships(_x, _x2) {
  return _getPendingMemberships.apply(this, arguments);
}
function _getPendingMemberships() {
  _getPendingMemberships = _asyncToGenerator(function* (params) {
    var _access_token;
