...
function editClanBanner(_x, _x2, _x3) {
  return _editClanBanner.apply(this, arguments);
}
function _editClanBanner() {
  _editClanBanner = _asyncToGenerator(function* (params, body) {
    var _access_token;
