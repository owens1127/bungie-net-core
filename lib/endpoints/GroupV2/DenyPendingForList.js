...
function denyPendingForList(_x, _x2, _x3) {
  return _denyPendingForList.apply(this, arguments);
}
function _denyPendingForList() {
  _denyPendingForList = _asyncToGenerator(function* (params, body) {
    var _access_token;
