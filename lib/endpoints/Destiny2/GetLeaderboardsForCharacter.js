...
function getLeaderboardsForCharacter(_x, _x2) {
  return _getLeaderboardsForCharacter.apply(this, arguments);
}
function _getLeaderboardsForCharacter() {
  _getLeaderboardsForCharacter = _asyncToGenerator(function* (params) {
    var _access_token;
