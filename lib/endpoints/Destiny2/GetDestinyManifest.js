...
function getDestinyManifest(_x) {
  return _getDestinyManifest.apply(this, arguments);
}
function _getDestinyManifest() {
  _getDestinyManifest = _asyncToGenerator(function* () {
    var _access_token;
