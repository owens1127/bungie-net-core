...
exports.updateLoadoutIdentifiers = updateLoadoutIdentifiers;
...
function updateLoadoutIdentifiers(_x, _x2) {
  return _updateLoadoutIdentifiers.apply(this, arguments);
}
function _updateLoadoutIdentifiers() {
  _updateLoadoutIdentifiers = _asyncToGenerator(function* (body) {
    var _access_token;
