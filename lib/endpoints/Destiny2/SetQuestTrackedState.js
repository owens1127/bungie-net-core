...
exports.setQuestTrackedState = setQuestTrackedState;
...
function setQuestTrackedState(_x, _x2) {
  return _setQuestTrackedState.apply(this, arguments);
}
function _setQuestTrackedState() {
  _setQuestTrackedState = _asyncToGenerator(function* (body) {
    var _access_token;
