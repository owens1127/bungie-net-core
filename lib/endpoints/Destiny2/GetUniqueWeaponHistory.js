...
function getUniqueWeaponHistory(_x, _x2) {
  return _getUniqueWeaponHistory.apply(this, arguments);
}
function _getUniqueWeaponHistory() {
  _getUniqueWeaponHistory = _asyncToGenerator(function* (params) {
    var _access_token;
