...
function setItemLockState(_x, _x2) {
  return _setItemLockState.apply(this, arguments);
}
function _setItemLockState() {
  _setItemLockState = _asyncToGenerator(function* (body) {
    var _access_token;
