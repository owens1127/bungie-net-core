...
function getClanAggregateStats(_x, _x2) {
  return _getClanAggregateStats.apply(this, arguments);
}
function _getClanAggregateStats() {
  _getClanAggregateStats = _asyncToGenerator(function* (params) {
    var _access_token;
