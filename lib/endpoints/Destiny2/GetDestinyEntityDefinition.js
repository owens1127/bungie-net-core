...
function getDestinyEntityDefinition(_x, _x2) {
  return _getDestinyEntityDefinition.apply(this, arguments);
}
function _getDestinyEntityDefinition() {
  _getDestinyEntityDefinition = _asyncToGenerator(function* (params) {
    var _access_token;
