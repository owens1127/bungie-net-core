...
exports.getDestinyEntityDefinition = void 0;
...
*/
function getDestinyEntityDefinition(params) {
    var _a, _b;
            ...
            switch (_c.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, (0, rate_limiter_1.rateLimitedRequest)(token, {
                            method: 'GET',
                            url: "https://www.bungie.net/Platform/Destiny2/Manifest/".concat(params.entityType, "/").concat(params.hashIdentifier, "/")
                        })];
