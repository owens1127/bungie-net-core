...
exports.getClanBannerSource = getClanBannerSource;
...
function getClanBannerSource(_x) {
  return _getClanBannerSource.apply(this, arguments);
}
function _getClanBannerSource() {
  _getClanBannerSource = _asyncToGenerator(function* () {
    var _access_token;
