...
function getLinkedProfiles(_x, _x2) {
  return _getLinkedProfiles.apply(this, arguments);
}
function _getLinkedProfiles() {
  _getLinkedProfiles = _asyncToGenerator(function* (params) {
    var _access_token;
