...
exports.getLinkedProfiles = void 0;
...
*/
function getLinkedProfiles(params) {
    var _a, _b;
            ...
            switch (_c.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, (0, rate_limiter_1.rateLimitedRequest)(token, {
                            method: 'GET',
                            url: "https://www.bungie.net/Platform/Destiny2/".concat(params.membershipType, "/Profile/").concat(params.membershipId, "/LinkedProfiles/"),
                            params: {
