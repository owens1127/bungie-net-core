...
exports.clearLoadout = clearLoadout;
...
function clearLoadout(_x, _x2) {
  return _clearLoadout.apply(this, arguments);
}
function _clearLoadout() {
  _clearLoadout = _asyncToGenerator(function* (body) {
    var _access_token;
