...
function getHistoricalStatsForAccount(_x, _x2) {
  return _getHistoricalStatsForAccount.apply(this, arguments);
}
function _getHistoricalStatsForAccount() {
  _getHistoricalStatsForAccount = _asyncToGenerator(function* (params) {
    var _access_token;
