...
function awaGetActionToken(_x, _x2) {
  return _awaGetActionToken.apply(this, arguments);
}
function _awaGetActionToken() {
  _awaGetActionToken = _asyncToGenerator(function* (params) {
    var _access_token;
