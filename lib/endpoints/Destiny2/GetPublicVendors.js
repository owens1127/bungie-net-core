...
function getPublicVendors(_x, _x2) {
  return _getPublicVendors.apply(this, arguments);
}
function _getPublicVendors() {
  _getPublicVendors = _asyncToGenerator(function* (params) {
    var _access_token;
