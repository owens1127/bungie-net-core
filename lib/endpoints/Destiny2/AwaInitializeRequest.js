...
function awaInitializeRequest(_x, _x2) {
  return _awaInitializeRequest.apply(this, arguments);
}
function _awaInitializeRequest() {
  _awaInitializeRequest = _asyncToGenerator(function* (body) {
    var _access_token;
