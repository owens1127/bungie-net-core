...
function getPostGameCarnageReport(_x, _x2) {
  return _getPostGameCarnageReport.apply(this, arguments);
}
function _getPostGameCarnageReport() {
  _getPostGameCarnageReport = _asyncToGenerator(function* (params) {
    var _access_token;
