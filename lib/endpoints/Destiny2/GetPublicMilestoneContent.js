...
function getPublicMilestoneContent(_x, _x2) {
  return _getPublicMilestoneContent.apply(this, arguments);
}
function _getPublicMilestoneContent() {
  _getPublicMilestoneContent = _asyncToGenerator(function* (params) {
    var _access_token;
