...
function getHistoricalStatsDefinition(_x) {
  return _getHistoricalStatsDefinition.apply(this, arguments);
}
function _getHistoricalStatsDefinition() {
  _getHistoricalStatsDefinition = _asyncToGenerator(function* () {
    var _access_token;
