...
function insertSocketPlug(_x, _x2) {
  return _insertSocketPlug.apply(this, arguments);
}
function _insertSocketPlug() {
  _insertSocketPlug = _asyncToGenerator(function* (body) {
    var _access_token;
