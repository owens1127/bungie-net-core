...
exports.snapshotLoadout = snapshotLoadout;
...
function snapshotLoadout(_x, _x2) {
  return _snapshotLoadout.apply(this, arguments);
}
function _snapshotLoadout() {
  _snapshotLoadout = _asyncToGenerator(function* (body) {
    var _access_token;
