...
exports.searchDestinyPlayerByBungieName = searchDestinyPlayerByBungieName;
...
function searchDestinyPlayerByBungieName(_x, _x2, _x3) {
  return _searchDestinyPlayerByBungieName.apply(this, arguments);
}
function _searchDestinyPlayerByBungieName() {
  _searchDestinyPlayerByBungieName = _asyncToGenerator(function* (params, body) {
    var _access_token;
