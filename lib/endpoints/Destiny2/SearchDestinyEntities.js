...
function searchDestinyEntities(_x, _x2) {
  return _searchDestinyEntities.apply(this, arguments);
}
function _searchDestinyEntities() {
  _searchDestinyEntities = _asyncToGenerator(function* (params) {
    var _access_token;
