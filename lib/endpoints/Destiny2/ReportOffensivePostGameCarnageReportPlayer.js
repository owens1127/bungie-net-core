...
exports.reportOffensivePostGameCarnageReportPlayer = void 0;
...
*/
function reportOffensivePostGameCarnageReportPlayer(params, body) {
    var _a, _b;
            ...
            switch (_c.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, (0, rate_limiter_1.rateLimitedRequest)(token, {
                            method: 'POST',
                            url: "https://stats.bungie.net/Platform/Destiny2/Stats/PostGameCarnageReport/".concat(params.activityId, "/Report/"),
                            body: body
                        })];
