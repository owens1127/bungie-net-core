...
function reportOffensivePostGameCarnageReportPlayer(_x, _x2, _x3) {
  return _reportOffensivePostGameCarnageReportPlayer.apply(this, arguments);
}
function _reportOffensivePostGameCarnageReportPlayer() {
  _reportOffensivePostGameCarnageReportPlayer = _asyncToGenerator(function* (params, body) {
    var _access_token;
