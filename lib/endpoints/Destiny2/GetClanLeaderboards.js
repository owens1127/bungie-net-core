...
exports.getClanLeaderboards = void 0;
...
*/
function getClanLeaderboards(params) {
    var _a, _b;
            ...
            switch (_c.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, (0, rate_limiter_1.rateLimitedRequest)(token, {
                            method: 'GET',
                            url: "https://www.bungie.net/Platform/Destiny2/Stats/Leaderboards/Clans/".concat(params.groupId, "/"),
                            params: {
