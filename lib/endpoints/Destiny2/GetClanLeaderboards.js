...
function getClanLeaderboards(_x, _x2) {
  return _getClanLeaderboards.apply(this, arguments);
}
function _getClanLeaderboards() {
  _getClanLeaderboards = _asyncToGenerator(function* (params) {
    var _access_token;
