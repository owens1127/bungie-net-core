...
function getPublicMilestones(_x) {
  return _getPublicMilestones.apply(this, arguments);
}
function _getPublicMilestones() {
  _getPublicMilestones = _asyncToGenerator(function* () {
    var _access_token;
