...
exports.insertSocketPlugFree = insertSocketPlugFree;
...
function insertSocketPlugFree(_x, _x2) {
  return _insertSocketPlugFree.apply(this, arguments);
}
function _insertSocketPlugFree() {
  _insertSocketPlugFree = _asyncToGenerator(function* (body) {
    var _access_token;
