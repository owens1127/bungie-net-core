...
/**
 * @typedef GetCharacterParams
 * @property {string} characterId ID of the character.
 ...
 * @returns Promise<import('../../util/server-response.d').BungieNetResponse<DestinyCharacterResponse>>
 * @this import(../../index).Client
 * @see {@link https://bungie-net.github.io/#Destiny2.GetCharacter}
*/
module.exports = async function getCharacter(params) {
