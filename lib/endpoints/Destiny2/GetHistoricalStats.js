...
function getHistoricalStats(_x, _x2) {
  return _getHistoricalStats.apply(this, arguments);
}
function _getHistoricalStats() {
  _getHistoricalStats = _asyncToGenerator(function* (params) {
    var _access_token;
