...
function getCollectibleNodeDetails(_x, _x2) {
  return _getCollectibleNodeDetails.apply(this, arguments);
}
function _getCollectibleNodeDetails() {
  _getCollectibleNodeDetails = _asyncToGenerator(function* (params) {
    var _access_token;
