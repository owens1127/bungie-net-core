...
function getClanWeeklyRewardState(_x, _x2) {
  return _getClanWeeklyRewardState.apply(this, arguments);
}
function _getClanWeeklyRewardState() {
  _getClanWeeklyRewardState = _asyncToGenerator(function* (params) {
    var _access_token;
