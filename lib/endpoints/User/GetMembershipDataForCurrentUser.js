...
function getMembershipDataForCurrentUser(_x) {
  return _getMembershipDataForCurrentUser.apply(this, arguments);
}
function _getMembershipDataForCurrentUser() {
  _getMembershipDataForCurrentUser = _asyncToGenerator(function* () {
    var _access_token;
