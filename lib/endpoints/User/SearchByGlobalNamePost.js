...
exports.searchByGlobalNamePost = searchByGlobalNamePost;
...
function searchByGlobalNamePost(_x, _x2, _x3) {
  return _searchByGlobalNamePost.apply(this, arguments);
}
function _searchByGlobalNamePost() {
  _searchByGlobalNamePost = _asyncToGenerator(function* (params, body) {
    var _access_token;
