...
exports.searchByGlobalNamePrefix = searchByGlobalNamePrefix;
...
function searchByGlobalNamePrefix(_x, _x2) {
  return _searchByGlobalNamePrefix.apply(this, arguments);
}
function _searchByGlobalNamePrefix() {
  _searchByGlobalNamePrefix = _asyncToGenerator(function* (params) {
    var _access_token;
