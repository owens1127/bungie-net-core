...
exports.getCredentialTypesForTargetAccount = getCredentialTypesForTargetAccount;
...
function getCredentialTypesForTargetAccount(_x, _x2) {
  return _getCredentialTypesForTargetAccount.apply(this, arguments);
}
function _getCredentialTypesForTargetAccount() {
  _getCredentialTypesForTargetAccount = _asyncToGenerator(function* (params) {
    var _access_token;
