...
function getSanitizedPlatformDisplayNames(_x, _x2) {
  return _getSanitizedPlatformDisplayNames.apply(this, arguments);
}
function _getSanitizedPlatformDisplayNames() {
  _getSanitizedPlatformDisplayNames = _asyncToGenerator(function* (params) {
    var _access_token;
