...
function getMembershipFromHardLinkedCredential(_x, _x2) {
  return _getMembershipFromHardLinkedCredential.apply(this, arguments);
}
function _getMembershipFromHardLinkedCredential() {
  _getMembershipFromHardLinkedCredential = _asyncToGenerator(function* (params) {
    var _access_token;
