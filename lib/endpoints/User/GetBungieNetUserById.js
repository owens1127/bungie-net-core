...
function getBungieNetUserById(_x, _x2) {
  return _getBungieNetUserById.apply(this, arguments);
}
function _getBungieNetUserById() {
  _getBungieNetUserById = _asyncToGenerator(function* (params) {
    var _access_token;
