...
function getMembershipDataById(_x, _x2) {
  return _getMembershipDataById.apply(this, arguments);
}
function _getMembershipDataById() {
  _getMembershipDataById = _asyncToGenerator(function* (params) {
    var _access_token;
