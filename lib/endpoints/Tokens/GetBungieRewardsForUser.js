...
function getBungieRewardsForUser(_x, _x2) {
  return _getBungieRewardsForUser.apply(this, arguments);
}
function _getBungieRewardsForUser() {
  _getBungieRewardsForUser = _asyncToGenerator(function* (params) {
    var _access_token;
