...
function getPartnerRewardHistory(_x, _x2) {
  return _getPartnerRewardHistory.apply(this, arguments);
}
function _getPartnerRewardHistory() {
  _getPartnerRewardHistory = _asyncToGenerator(function* (params) {
    var _access_token;
