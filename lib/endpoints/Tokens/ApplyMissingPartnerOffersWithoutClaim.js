...
function applyMissingPartnerOffersWithoutClaim(_x, _x2) {
  return _applyMissingPartnerOffersWithoutClaim.apply(this, arguments);
}
function _applyMissingPartnerOffersWithoutClaim() {
  _applyMissingPartnerOffersWithoutClaim = _asyncToGenerator(function* (params) {
    var _access_token;
