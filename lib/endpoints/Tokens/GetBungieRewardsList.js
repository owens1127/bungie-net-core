...
function getBungieRewardsList(_x) {
  return _getBungieRewardsList.apply(this, arguments);
}
function _getBungieRewardsList() {
  _getBungieRewardsList = _asyncToGenerator(function* () {
    var _access_token;
