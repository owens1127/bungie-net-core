...
function getPartnerOfferSkuHistory(_x, _x2) {
  return _getPartnerOfferSkuHistory.apply(this, arguments);
}
function _getPartnerOfferSkuHistory() {
  _getPartnerOfferSkuHistory = _asyncToGenerator(function* (params) {
    var _access_token;
