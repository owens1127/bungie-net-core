...
function getBungieRewardsForPlatformUser(_x, _x2) {
  return _getBungieRewardsForPlatformUser.apply(this, arguments);
}
function _getBungieRewardsForPlatformUser() {
  _getBungieRewardsForPlatformUser = _asyncToGenerator(function* (params) {
    var _access_token;
