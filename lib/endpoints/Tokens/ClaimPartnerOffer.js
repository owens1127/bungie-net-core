...
function claimPartnerOffer(_x, _x2) {
  return _claimPartnerOffer.apply(this, arguments);
}
function _claimPartnerOffer() {
  _claimPartnerOffer = _asyncToGenerator(function* (body) {
    var _access_token;
