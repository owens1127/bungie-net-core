...
export interface DestinyItemComponentSetOfint32<T extends DestinyComponentType[]> {
  readonly instances: ConditionalComponent<
    ...
    DictionaryComponentResponse<number, DestinyItemInstanceComponent>
  >;
  readonly renderData: ConditionalComponent<
    T,
    DestinyComponentType.ItemRenderData,
    DictionaryComponentResponse<number, DestinyItemRenderComponent>
  >;
  readonly stats: ConditionalComponent<
    T,
    DestinyComponentType.ItemStats,
    DictionaryComponentResponse<number, DestinyItemStatsComponent>
  >;
  readonly sockets: ConditionalComponent<
    T,
    DestinyComponentType.ItemSockets,
    DictionaryComponentResponse<number, DestinyItemSocketsComponent>
  >;
  readonly reusablePlugs: ConditionalComponent<
    T,
    DestinyComponentType.ItemReusablePlugs,
    DictionaryComponentResponse<number, DestinyItemReusablePlugsComponent>
  >;
  readonly plugObjectives: ConditionalComponent<
    T,
    DestinyComponentType.ItemPlugObjectives,
    DictionaryComponentResponse<number, DestinyItemPlugObjectivesComponent>
  >;
  readonly talentGrids: ConditionalComponent<
    T,
    DestinyComponentType.ItemTalentGrids,
    DictionaryComponentResponse<number, DestinyItemTalentGridComponent>
  >;
  ...
  readonly objectives: ConditionalComponent<
    ...
    DictionaryComponentResponse<number, DestinyItemObjectivesComponent>
  >;
  readonly perks: ConditionalComponent<
    T,
    DestinyComponentType.ItemPerks,
    DictionaryComponentResponse<number, DestinyItemPerksComponent>
  >;
}
