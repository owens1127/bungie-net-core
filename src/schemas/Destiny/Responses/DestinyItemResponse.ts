...
export interface DestinyItemResponse<T extends DestinyComponentType[]> extends ComponentData {
  ...
  */
  readonly item: ConditionalComponent<T, DestinyComponentType.ItemCommonData, SingleComponentResponse<DestinyItemComponent>>;
  /**
   * Basic instance data for the item.
   *
   * COMPONENT TYPE: ItemInstances
  */
  readonly instance: ConditionalComponent<T, DestinyComponentType.ItemInstances, SingleComponentResponse<DestinyItemInstanceComponent>>;
  /**
   * Information specifically about the item's objectives.
   *
   * COMPONENT TYPE: ItemObjectives
  */
  readonly objectives: ConditionalComponent<T, DestinyComponentType.ItemObjectives, SingleComponentResponse<DestinyItemObjectivesComponent>>;
  /**
   * Information specifically about the perks currently active on the item.
   *
   * COMPONENT TYPE: ItemPerks
  */
  readonly perks: ConditionalComponent<T, DestinyComponentType.ItemPerks, SingleComponentResponse<DestinyItemPerksComponent>>;
  /**
   * Information about how to render the item in 3D.
   *
   * COMPONENT TYPE: ItemRenderData
  */
  readonly renderData: ConditionalComponent<T, DestinyComponentType.ItemRenderData, SingleComponentResponse<DestinyItemRenderComponent>>;
  /**
   * Information about the computed stats of the item: power, defense, etc...
   *
   * COMPONENT TYPE: ItemStats
  */
  readonly stats: ConditionalComponent<T, DestinyComponentType.ItemStats, SingleComponentResponse<DestinyItemStatsComponent>>;
  /**
  ...
  */
  readonly talentGrid: ConditionalComponent<T, DestinyComponentType.ItemTalentGrids, SingleComponentResponse<DestinyItemTalentGridComponent>>;
  /**
  ...
  */
  readonly sockets: ConditionalComponent<T, DestinyComponentType.ItemSockets, SingleComponentResponse<DestinyItemSocketsComponent>>;
  /**
  ...
  */
  readonly reusablePlugs: ConditionalComponent<T, DestinyComponentType.ItemReusablePlugs, SingleComponentResponse<DestinyItemReusablePlugsComponent>>;
  /**
  ...
  */
  readonly plugObjectives: ConditionalComponent<T, DestinyComponentType.ItemPlugObjectives, SingleComponentResponse<DestinyItemPlugObjectivesComponent>>;
}
