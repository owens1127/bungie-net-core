...
import { DestinyItemTooltipNotification } from './DestinyItemTooltipNotification.js'
import { DestinyColor } from '../Misc/DestinyColor.js'
import { DestinyItemActionBlockDefinition } from './DestinyItemActionBlockDefinition.js'
import { DestinyItemCraftingBlockDefinition } from './DestinyItemCraftingBlockDefinition.js'
import { DestinyItemInventoryBlockDefinition } from './DestinyItemInventoryBlockDefinition.js'
import { DestinyItemSetBlockDefinition } from './DestinyItemSetBlockDefinition.js'
import { DestinyItemStatBlockDefinition } from './DestinyItemStatBlockDefinition.js'
import { DestinyEquippingBlockDefinition } from './DestinyEquippingBlockDefinition.js'
import { DestinyItemTranslationBlockDefinition } from './DestinyItemTranslationBlockDefinition.js'
import { DestinyItemPreviewBlockDefinition } from './DestinyItemPreviewBlockDefinition.js'
import { DestinyItemQualityBlockDefinition } from './DestinyItemQualityBlockDefinition.js'
import { DestinyItemValueBlockDefinition } from './DestinyItemValueBlockDefinition.js'
import { DestinyItemSourceBlockDefinition } from './DestinyItemSourceBlockDefinition.js'
import { DestinyItemObjectiveBlockDefinition } from './DestinyItemObjectiveBlockDefinition.js'
import { DestinyItemMetricBlockDefinition } from './DestinyItemMetricBlockDefinition.js'
import { DestinyItemPlugDefinition } from './Items/DestinyItemPlugDefinition.js'
import { DestinyItemGearsetBlockDefinition } from './DestinyItemGearsetBlockDefinition.js'
import { DestinyItemSackBlockDefinition } from './DestinyItemSackBlockDefinition.js'
import { DestinyItemSocketBlockDefinition } from './DestinyItemSocketBlockDefinition.js'
import { DestinyItemSummaryBlockDefinition } from './DestinyItemSummaryBlockDefinition.js'
import { DestinyItemTalentGridBlockDefinition } from './DestinyItemTalentGridBlockDefinition.js'
import { DestinyItemInvestmentStatDefinition } from './DestinyItemInvestmentStatDefinition.js'
import { DestinyItemPerkEntryDefinition } from './DestinyItemPerkEntryDefinition.js'
import { DestinyAnimationReference } from './Animations/DestinyAnimationReference.js'
import { HyperlinkReference } from '../../Links/HyperlinkReference.js'
import { SpecialItemType } from '../SpecialItemType.js'
...
export interface DestinyInventoryItemDefinition {
  ...
  */
   ...
   * that collectible entry. Mapped to DestinyCollectibleDefinition in the manifest.
  */
  ...
  */
   ...
   * identifier you can use to look up the lore definition. Mapped to
   * DestinyLoreDefinition in the manifest.
  */
   ...
   * the item displayed instead, if it exists. Mapped to
  ...
  */
   ...
   * miscategorized item, please let us know on the Bungie API forums. Mapped to
  ...
  */
   ...
   * definition depends on what's cleanest for your code. Mapped to
  ...
  */
   ...
   * possible damage types that are available to the weapon by default. Mapped to
  ...
  */
   ...
   * but for now they're very convenient. Mapped to DestinyDamageTypeDefinition in
   * the manifest.
  */
  readonly defaultDamageTypeHash?: number;
  /**
   * If this item is related directly to a Season of Destiny, this is the hash
   * identifier for that season. Mapped to DestinySeasonDefinition in the manifest.
  */
