...
export async function getBungieNetUserById(
  ...
  const baseUrl = `https://www.bungie.net/Platform/User/GetBungieNetUserById/${params.id}/`;
  const searchParams = undefined;
  return await http<BungieNetResponse<GeneralUser>>({ method: 'GET', baseUrl, searchParams, body: undefined });
}
...
export async function getSanitizedPlatformDisplayNames(
  ...
  const baseUrl = `https://www.bungie.net/Platform/User/GetSanitizedPlatformDisplayNames/${params.membershipId}/`;
  const searchParams = undefined;
  return await http<BungieNetResponse<{ [key in BungieCredentialType]: string }>>({
    method: 'GET',
    baseUrl,
    searchParams,
    body: undefined
...
export async function getCredentialTypesForTargetAccount(
  ...
  const baseUrl = `https://www.bungie.net/Platform/User/GetCredentialTypesForTargetAccount/${params.membershipId}/`;
  const searchParams = undefined;
  return await http<BungieNetResponse<GetCredentialTypesForAccountResponse[]>>({
    method: 'GET',
    baseUrl,
    searchParams,
    body: undefined
 ...
 */
export async function getAvailableThemes(http: BungieHttpProtocol): Promise<BungieNetResponse<UserTheme[]>> {
  const baseUrl = `https://www.bungie.net/Platform/User/GetAvailableThemes/`;
  const searchParams = undefined;
  return await http<BungieNetResponse<UserTheme[]>>({ method: 'GET', baseUrl, searchParams, body: undefined });
}
...
export async function getMembershipDataById(
  ...
  const baseUrl = `https://www.bungie.net/Platform/User/GetMembershipsById/${params.membershipId}/${params.membershipType}/`;
  const searchParams = undefined;
  return await http<BungieNetResponse<UserMembershipData>>({ method: 'GET', baseUrl, searchParams, body: undefined });
}
...
export async function getMembershipDataForCurrentUser(
  ...
  const baseUrl = `https://www.bungie.net/Platform/User/GetMembershipsForCurrentUser/`;
  const searchParams = undefined;
  return await http<BungieNetResponse<UserMembershipData>>({ method: 'GET', baseUrl, searchParams, body: undefined });
}
...
export async function getMembershipFromHardLinkedCredential(
  ...
  const baseUrl = `https://www.bungie.net/Platform/User/GetMembershipFromHardLinkedCredential/${params.crType}/${params.credential}/`;
  const searchParams = undefined;
  return await http<BungieNetResponse<HardLinkedUserMembership>>({
    method: 'GET',
    baseUrl,
    searchParams,
    body: undefined
...
export async function searchByGlobalNamePrefix(
  ...
  const baseUrl = `https://www.bungie.net/Platform/User/Search/Prefix/${params.displayNamePrefix}/${params.page}/`;
  const searchParams = undefined;
  return await http<BungieNetResponse<UserSearchResponse>>({ method: 'GET', baseUrl, searchParams, body: undefined });
}
...
export async function searchByGlobalNamePost(
  ...
  const baseUrl = `https://www.bungie.net/Platform/User/Search/GlobalName/${params.page}/`;
  const searchParams = undefined;
  return await http<BungieNetResponse<UserSearchResponse>, UserSearchPrefixRequest>({
    method: 'POST',
    baseUrl,
    searchParams,
    body,
