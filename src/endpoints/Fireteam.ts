...
export async function getActivePrivateClanFireteamCount(
  ...
  return await http<BungieNetResponse<number>>({ method: 'GET', baseUrl, searchParams, body: undefined });
}
...
export async function getAvailableClanFireteams(
  ...
  if (params.excludeImmediate !== undefined)
    searchParams.append('excludeImmediate', params.excludeImmediate.toString());
  if (params.langFilter !== undefined) searchParams.append('langFilter', params.langFilter.toString());
  return await http<BungieNetResponse<SearchResultOfFireteamSummary>>({
    method: 'GET',
    baseUrl,
    searchParams,
    body: undefined
...
export async function getMyClanFireteams(
  ...
  if (params.langFilter !== undefined) searchParams.append('langFilter', params.langFilter.toString());
  return await http<BungieNetResponse<SearchResultOfFireteamResponse>>({
    method: 'GET',
    baseUrl,
    searchParams,
    body: undefined
...
export async function getClanFireteam(
  ...
  const searchParams = undefined;
  return await http<BungieNetResponse<FireteamResponse>>({ method: 'GET', baseUrl, searchParams, body: undefined });
}
