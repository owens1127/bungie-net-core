 ...
 * @see {@link https://bungie-net.github.io/#CommunityContent.GetCommunityContent}
*/
export async function getCommunityContent(this: InstancedImport | AccessTokenObject | void, params: GetCommunityContentParams): Promise<BungieNetResponse<PostSearchResponse>> {
