 ...
 * @see {@link https://bungie-net.github.io/#User.GetMembershipDataById}
*/
export async function getMembershipDataById(this:  AccessTokenObject | void, params: GetMembershipDataByIdParams): Promise<BungieNetResponse<UserMembershipData>> {
