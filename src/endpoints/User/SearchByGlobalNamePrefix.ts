 ...
 * @see {@link https://bungie-net.github.io/#User.SearchByGlobalNamePrefix}
*/
export async function searchByGlobalNamePrefix(this: InstancedImport | AccessTokenObject | void, params: SearchByGlobalNamePrefixParams): Promise<BungieNetResponse<UserSearchResponse>> {
