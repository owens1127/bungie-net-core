 ...
 * @see {@link https://bungie-net.github.io/#User.SearchByGlobalNamePrefix}
*/
export async function searchByGlobalNamePrefix(this:  AccessTokenObject | void, params: SearchByGlobalNamePrefixParams): Promise<BungieNetResponse<UserSearchResponse>> {
