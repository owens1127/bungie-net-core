 ...
 * @see {@link https://bungie-net.github.io/#User.SearchByGlobalNamePost}
*/
export async function searchByGlobalNamePost(this: InstancedImport | AccessTokenObject | void, params: SearchByGlobalNamePostParams, body: UserSearchPrefixRequest): Promise<BungieNetResponse<UserSearchResponse>> {
