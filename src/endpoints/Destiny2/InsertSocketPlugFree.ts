...
*/
export async function insertSocketPlugFree(this:  AccessTokenObject | void, body: DestinyInsertPlugsFreeActionRequest): Promise<BungieNetResponse<DestinyItemChangeResponse>> {
