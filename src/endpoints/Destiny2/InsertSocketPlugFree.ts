...
*/
export async function insertSocketPlugFree(this: InstancedImport | AccessTokenObject | void, body: DestinyInsertPlugsFreeActionRequest): Promise<BungieNetResponse<DestinyItemChangeResponse>> {
