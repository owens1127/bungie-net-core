 ...
 * @see {@link https://bungie-net.github.io/#Destiny2.GetClanAggregateStats}
*/
export async function getClanAggregateStats(this:  AccessTokenObject | void, params: GetClanAggregateStatsParams): Promise<BungieNetResponse<DestinyClanAggregateStat[]>> {
