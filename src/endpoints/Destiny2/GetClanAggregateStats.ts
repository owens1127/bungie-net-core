 ...
 * @see {@link https://bungie-net.github.io/#Destiny2.GetClanAggregateStats}
*/
export async function getClanAggregateStats(this: InstancedImport | AccessTokenObject | void, params: GetClanAggregateStatsParams): Promise<BungieNetResponse<DestinyClanAggregateStat[]>> {
