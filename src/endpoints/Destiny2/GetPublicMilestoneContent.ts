 ...
 * @see {@link https://bungie-net.github.io/#Destiny2.GetPublicMilestoneContent}
*/
export async function getPublicMilestoneContent(this:  AccessTokenObject | void, params: GetPublicMilestoneContentParams): Promise<BungieNetResponse<DestinyMilestoneContent>> {
