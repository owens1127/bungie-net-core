 ...
 * @see {@link https://bungie-net.github.io/#Destiny2.GetItem}
*/
export async function getItem<T extends DestinyComponentType[]>(this: InstancedImport | AccessTokenObject | void, params: GetItemParams<T>): Promise<BungieNetResponse<DestinyItemResponse<T>>> {
