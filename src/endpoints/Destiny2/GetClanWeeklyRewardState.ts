 ...
 * @see {@link https://bungie-net.github.io/#Destiny2.GetClanWeeklyRewardState}
*/
export async function getClanWeeklyRewardState(this:  AccessTokenObject | void, params: GetClanWeeklyRewardStateParams): Promise<BungieNetResponse<DestinyMilestone>> {
