...
*/
export async function updateLoadoutIdentifiers(this: InstancedImport | AccessTokenObject | void, body: DestinyLoadoutUpdateActionRequest): Promise<BungieNetResponse<number>> {
