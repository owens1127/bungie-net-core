...
*/
export async function equipItems(this: InstancedImport | AccessTokenObject | void, body: DestinyItemSetActionRequest): Promise<BungieNetResponse<DestinyEquipItemResults>> {
