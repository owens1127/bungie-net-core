 ...
 * @see {@link https://bungie-net.github.io/#Destiny2.GetDestinyEntityDefinition}
*/
export async function getDestinyEntityDefinition(this: InstancedImport | AccessTokenObject | void, params: GetDestinyEntityDefinitionParams): Promise<BungieNetResponse<DestinyDefinition>> {
