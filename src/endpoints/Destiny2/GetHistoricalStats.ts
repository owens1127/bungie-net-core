 ...
 * @see {@link https://bungie-net.github.io/#Destiny2.GetHistoricalStats}
*/
export async function getHistoricalStats(this: InstancedImport | AccessTokenObject | void, params: GetHistoricalStatsParams): Promise<BungieNetResponse<{ [key: string]: DestinyHistoricalStatsByPeriod }>> {
