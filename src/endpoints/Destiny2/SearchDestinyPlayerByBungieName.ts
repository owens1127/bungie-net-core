 ...
 * @see {@link https://bungie-net.github.io/#Destiny2.SearchDestinyPlayerByBungieName}
*/
export async function searchDestinyPlayerByBungieName(this: InstancedImport | AccessTokenObject | void, params: SearchDestinyPlayerByBungieNameParams, body: ExactSearchRequest): Promise<BungieNetResponse<UserInfoCard[]>> {
