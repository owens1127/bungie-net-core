 ...
 * @see {@link https://bungie-net.github.io/#Destiny2.GetLeaderboardsForCharacter}
*/
export async function getLeaderboardsForCharacter(this: InstancedImport | AccessTokenObject | void, params: GetLeaderboardsForCharacterParams): Promise<BungieNetResponse<{ [key: string]: { [key: string]: DestinyLeaderboard } }>> {
