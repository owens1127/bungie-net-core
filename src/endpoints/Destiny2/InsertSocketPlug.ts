...
*/
export async function insertSocketPlug(this: InstancedImport | AccessTokenObject | void, body: DestinyInsertPlugsActionRequest): Promise<BungieNetResponse<DestinyItemChangeResponse>> {
