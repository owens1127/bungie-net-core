...
*/
export async function insertSocketPlug(this:  AccessTokenObject | void, body: DestinyInsertPlugsActionRequest): Promise<BungieNetResponse<DestinyItemChangeResponse>> {
