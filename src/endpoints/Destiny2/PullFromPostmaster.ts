...
*/
export async function pullFromPostmaster(this: InstancedImport | AccessTokenObject | void, body: DestinyPostmasterTransferRequest): Promise<BungieNetResponse<number>> {
