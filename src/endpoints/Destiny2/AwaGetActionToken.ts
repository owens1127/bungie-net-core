 ...
 * @see {@link https://bungie-net.github.io/#Destiny2.AwaGetActionToken}
*/
export async function awaGetActionToken(this: InstancedImport | AccessTokenObject | void, params: AwaGetActionTokenParams): Promise<BungieNetResponse<AwaAuthorizationResult>> {
