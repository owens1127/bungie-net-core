 ...
 * @see {@link https://bungie-net.github.io/#Destiny2.GetVendors}
*/
export async function getVendors<T extends DestinyComponentType[]>(this: InstancedImport | AccessTokenObject | void, params: GetVendorsParams<T>): Promise<BungieNetResponse<DestinyVendorsResponse<T>>> {
