 ...
 * @see {@link https://bungie-net.github.io/#Destiny2.GetLeaderboards}
*/
export async function getLeaderboards(this: InstancedImport | AccessTokenObject | void, params: GetLeaderboardsParams): Promise<BungieNetResponse<{ [key: string]: { [key: string]: DestinyLeaderboard } }>> {
