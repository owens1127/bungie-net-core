 ...
 * @see {@link https://bungie-net.github.io/#Destiny2.GetActivityHistory}
*/
export async function getActivityHistory(this:  AccessTokenObject | void, params: GetActivityHistoryParams): Promise<BungieNetResponse<DestinyActivityHistoryResults>> {
