...
*/
export async function getHistoricalStatsDefinition(this: InstancedImport | AccessTokenObject | void): Promise<BungieNetResponse<{ [key: string]: DestinyHistoricalStatsDefinition }>> {
