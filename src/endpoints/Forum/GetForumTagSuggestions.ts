 ...
 * @see {@link https://bungie-net.github.io/#Forum.GetForumTagSuggestions}
*/
export async function getForumTagSuggestions(this: InstancedImport | AccessTokenObject | void, params: GetForumTagSuggestionsParams): Promise<BungieNetResponse<TagResponse[]>> {
