 ...
 * @see {@link https://bungie-net.github.io/#Forum.GetPostAndParent}
*/
export async function getPostAndParent(this: InstancedImport | AccessTokenObject | void, params: GetPostAndParentParams): Promise<BungieNetResponse<PostSearchResponse>> {
