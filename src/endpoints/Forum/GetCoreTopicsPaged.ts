 ...
 * @see {@link https://bungie-net.github.io/#Forum.GetCoreTopicsPaged}
*/
export async function getCoreTopicsPaged(this: InstancedImport | AccessTokenObject | void, params: GetCoreTopicsPagedParams): Promise<BungieNetResponse<PostSearchResponse>> {
