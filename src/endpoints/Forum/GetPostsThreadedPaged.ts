 ...
 * @see {@link https://bungie-net.github.io/#Forum.GetPostsThreadedPaged}
*/
export async function getPostsThreadedPaged(this:  AccessTokenObject | void, params: GetPostsThreadedPagedParams): Promise<BungieNetResponse<PostSearchResponse>> {
