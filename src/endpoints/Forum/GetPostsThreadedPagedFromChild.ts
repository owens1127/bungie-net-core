 ...
 * @see {@link https://bungie-net.github.io/#Forum.GetPostsThreadedPagedFromChild}
*/
export async function getPostsThreadedPagedFromChild(this: InstancedImport | AccessTokenObject | void, params: GetPostsThreadedPagedFromChildParams): Promise<BungieNetResponse<PostSearchResponse>> {
