 ...
 * @see {@link https://bungie-net.github.io/#Forum.GetPostAndParentAwaitingApproval}
*/
export async function getPostAndParentAwaitingApproval(this:  AccessTokenObject | void, params: GetPostAndParentAwaitingApprovalParams): Promise<BungieNetResponse<PostSearchResponse>> {
