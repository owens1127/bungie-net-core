 ...
 * @see {@link https://bungie-net.github.io/#GroupV2.EditOptionalConversation}
*/
export async function editOptionalConversation(this: InstancedImport | AccessTokenObject | void, params: EditOptionalConversationParams, body: GroupOptionalConversationEditRequest): Promise<BungieNetResponse<string>> {
