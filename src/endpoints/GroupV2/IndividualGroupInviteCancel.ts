 ...
 * @see {@link https://bungie-net.github.io/#GroupV2.IndividualGroupInviteCancel}
*/
export async function individualGroupInviteCancel(this:  AccessTokenObject | void, params: IndividualGroupInviteCancelParams): Promise<BungieNetResponse<GroupApplicationResponse>> {
