 ...
 * @see {@link https://bungie-net.github.io/#GroupV2.GetPotentialGroupsForMember}
*/
export async function getPotentialGroupsForMember(this:  AccessTokenObject | void, params: GetPotentialGroupsForMemberParams): Promise<BungieNetResponse<GroupPotentialMembershipSearchResponse>> {
