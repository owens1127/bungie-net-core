 ...
 * @see {@link https://bungie-net.github.io/#GroupV2.GetPotentialGroupsForMember}
*/
export async function getPotentialGroupsForMember(this: InstancedImport | AccessTokenObject | void, params: GetPotentialGroupsForMemberParams): Promise<BungieNetResponse<GroupPotentialMembershipSearchResponse>> {
