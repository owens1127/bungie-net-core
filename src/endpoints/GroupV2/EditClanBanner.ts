 ...
 * @see {@link https://bungie-net.github.io/#GroupV2.EditClanBanner}
*/
export async function editClanBanner(this: InstancedImport | AccessTokenObject | void, params: EditClanBannerParams, body: ClanBanner): Promise<BungieNetResponse<number>> {
