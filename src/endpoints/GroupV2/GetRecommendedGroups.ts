 ...
 * @see {@link https://bungie-net.github.io/#GroupV2.GetRecommendedGroups}
*/
export async function getRecommendedGroups(this: InstancedImport | AccessTokenObject | void, params: GetRecommendedGroupsParams): Promise<BungieNetResponse<GroupV2Card[]>> {
