 ...
 * @see {@link https://bungie-net.github.io/#GroupV2.GetUserClanInviteSetting}
*/
export async function getUserClanInviteSetting(this: InstancedImport | AccessTokenObject | void, params: GetUserClanInviteSettingParams): Promise<BungieNetResponse<boolean>> {
