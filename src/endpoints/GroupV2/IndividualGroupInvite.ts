 ...
 * @see {@link https://bungie-net.github.io/#GroupV2.IndividualGroupInvite}
*/
export async function individualGroupInvite(this:  AccessTokenObject | void, params: IndividualGroupInviteParams, body: GroupApplicationRequest): Promise<BungieNetResponse<GroupApplicationResponse>> {
