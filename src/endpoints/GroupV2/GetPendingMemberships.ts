 ...
 * @see {@link https://bungie-net.github.io/#GroupV2.GetPendingMemberships}
*/
export async function getPendingMemberships(this: InstancedImport | AccessTokenObject | void, params: GetPendingMembershipsParams): Promise<BungieNetResponse<SearchResultOfGroupMemberApplication>> {
