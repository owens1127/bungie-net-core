 ...
 * @see {@link https://bungie-net.github.io/#GroupV2.ApprovePending}
*/
export async function approvePending(this:  AccessTokenObject | void, params: ApprovePendingParams, body: GroupApplicationRequest): Promise<BungieNetResponse<boolean>> {
