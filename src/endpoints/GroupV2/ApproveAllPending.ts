 ...
 * @see {@link https://bungie-net.github.io/#GroupV2.ApproveAllPending}
*/
export async function approveAllPending(this: InstancedImport | AccessTokenObject | void, params: ApproveAllPendingParams, body: GroupApplicationRequest): Promise<BungieNetResponse<EntityActionResult[]>> {
