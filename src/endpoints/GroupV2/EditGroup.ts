 ...
 * @see {@link https://bungie-net.github.io/#GroupV2.EditGroup}
*/
export async function editGroup(this: InstancedImport | AccessTokenObject | void, params: EditGroupParams, body: GroupEditAction): Promise<BungieNetResponse<number>> {
