 ...
 * @see {@link https://bungie-net.github.io/#GroupV2.GetMembersOfGroup}
*/
export async function getMembersOfGroup(this:  AccessTokenObject | void, params: GetMembersOfGroupParams): Promise<BungieNetResponse<SearchResultOfGroupMember>> {
