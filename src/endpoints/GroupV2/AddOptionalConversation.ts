 ...
 * @see {@link https://bungie-net.github.io/#GroupV2.AddOptionalConversation}
*/
export async function addOptionalConversation(this:  AccessTokenObject | void, params: AddOptionalConversationParams, body: GroupOptionalConversationAddRequest): Promise<BungieNetResponse<string>> {
