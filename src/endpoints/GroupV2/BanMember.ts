 ...
 * @see {@link https://bungie-net.github.io/#GroupV2.BanMember}
*/
export async function banMember(this: InstancedImport | AccessTokenObject | void, params: BanMemberParams, body: GroupBanRequest): Promise<BungieNetResponse<number>> {
