 ...
 * @see {@link https://bungie-net.github.io/#GroupV2.EditGroupMembership}
*/
export async function editGroupMembership(this: InstancedImport | AccessTokenObject | void, params: EditGroupMembershipParams): Promise<BungieNetResponse<number>> {
