 ...
 * @see {@link https://bungie-net.github.io/#GroupV2.GetBannedMembersOfGroup}
*/
export async function getBannedMembersOfGroup(this: InstancedImport | AccessTokenObject | void, params: GetBannedMembersOfGroupParams): Promise<BungieNetResponse<SearchResultOfGroupBan>> {
