 ...
 * @see {@link https://bungie-net.github.io/#Social.AcceptFriendRequest}
*/
export async function acceptFriendRequest(this: InstancedImport | AccessTokenObject | void, params: AcceptFriendRequestParams): Promise<BungieNetResponse<boolean>> {
