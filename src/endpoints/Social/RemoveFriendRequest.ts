 ...
 * @see {@link https://bungie-net.github.io/#Social.RemoveFriendRequest}
*/
export async function removeFriendRequest(this: InstancedImport | AccessTokenObject | void, params: RemoveFriendRequestParams): Promise<BungieNetResponse<boolean>> {
