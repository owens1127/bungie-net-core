 ...
 * @see {@link https://bungie-net.github.io/#Social.IssueFriendRequest}
*/
export async function issueFriendRequest(this: InstancedImport | AccessTokenObject | void, params: IssueFriendRequestParams): Promise<BungieNetResponse<boolean>> {
