 ...
 * @see {@link https://bungie-net.github.io/#Social.DeclineFriendRequest}
*/
export async function declineFriendRequest(this: InstancedImport | AccessTokenObject | void, params: DeclineFriendRequestParams): Promise<BungieNetResponse<boolean>> {
