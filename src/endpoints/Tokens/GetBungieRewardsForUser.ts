 ...
 * @see {@link https://bungie-net.github.io/#Tokens.GetBungieRewardsForUser}
*/
export async function getBungieRewardsForUser(this:  AccessTokenObject | void, params: GetBungieRewardsForUserParams): Promise<BungieNetResponse<{ [key: string]: BungieRewardDisplay }>> {
