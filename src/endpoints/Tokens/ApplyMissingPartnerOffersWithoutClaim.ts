 ...
 * @see {@link https://bungie-net.github.io/#Tokens.ApplyMissingPartnerOffersWithoutClaim}
*/
export async function applyMissingPartnerOffersWithoutClaim(this: InstancedImport | AccessTokenObject | void, params: ApplyMissingPartnerOffersWithoutClaimParams): Promise<BungieNetResponse<boolean>> {
