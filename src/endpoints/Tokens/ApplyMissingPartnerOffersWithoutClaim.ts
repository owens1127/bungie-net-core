 ...
 * @see {@link https://bungie-net.github.io/#Tokens.ApplyMissingPartnerOffersWithoutClaim}
*/
export async function applyMissingPartnerOffersWithoutClaim(this:  AccessTokenObject | void, params: ApplyMissingPartnerOffersWithoutClaimParams): Promise<BungieNetResponse<boolean>> {
