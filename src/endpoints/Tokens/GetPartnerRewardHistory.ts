 ...
 * @see {@link https://bungie-net.github.io/#Tokens.GetPartnerRewardHistory}
*/
export async function getPartnerRewardHistory(this:  AccessTokenObject | void, params: GetPartnerRewardHistoryParams): Promise<BungieNetResponse<PartnerRewardHistoryResponse>> {
