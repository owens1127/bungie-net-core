 ...
 * @see {@link https://bungie-net.github.io/#Tokens.GetBungieRewardsForPlatformUser}
*/
export async function getBungieRewardsForPlatformUser(this: InstancedImport | AccessTokenObject | void, params: GetBungieRewardsForPlatformUserParams): Promise<BungieNetResponse<{ [key: string]: BungieRewardDisplay }>> {
