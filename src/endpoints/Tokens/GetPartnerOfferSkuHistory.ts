 ...
 * @see {@link https://bungie-net.github.io/#Tokens.GetPartnerOfferSkuHistory}
*/
export async function getPartnerOfferSkuHistory(this:  AccessTokenObject | void, params: GetPartnerOfferSkuHistoryParams): Promise<BungieNetResponse<PartnerOfferSkuHistoryResponse[]>> {
