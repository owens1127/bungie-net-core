 ...
 * @see {@link https://bungie-net.github.io/#Content.GetContentType}
*/
export async function getContentType(this: InstancedImport | AccessTokenObject | void, params: GetContentTypeParams): Promise<BungieNetResponse<ContentTypeDescription>> {
