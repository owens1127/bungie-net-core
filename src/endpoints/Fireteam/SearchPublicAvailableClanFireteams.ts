 ...
 * @see {@link https://bungie-net.github.io/#Fireteam.SearchPublicAvailableClanFireteams}
*/
export async function searchPublicAvailableClanFireteams(this:  AccessTokenObject | void, params: SearchPublicAvailableClanFireteamsParams): Promise<BungieNetResponse<SearchResultOfFireteamSummary>> {
