 ...
 * @see {@link https://bungie-net.github.io/#Fireteam.GetClanFireteam}
*/
export async function getClanFireteam(this: InstancedImport | AccessTokenObject | void, params: GetClanFireteamParams): Promise<BungieNetResponse<FireteamResponse>> {
