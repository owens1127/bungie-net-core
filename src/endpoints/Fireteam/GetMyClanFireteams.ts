 ...
 * @see {@link https://bungie-net.github.io/#Fireteam.GetMyClanFireteams}
*/
export async function getMyClanFireteams(this:  AccessTokenObject | void, params: GetMyClanFireteamsParams): Promise<BungieNetResponse<SearchResultOfFireteamResponse>> {
