 ...
 * @see {@link https://bungie-net.github.io/#Fireteam.GetMyClanFireteams}
*/
export async function getMyClanFireteams(this: InstancedImport | AccessTokenObject | void, params: GetMyClanFireteamsParams): Promise<BungieNetResponse<SearchResultOfFireteamResponse>> {
