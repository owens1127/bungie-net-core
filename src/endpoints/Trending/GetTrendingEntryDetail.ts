 ...
 * @see {@link https://bungie-net.github.io/#Trending.GetTrendingEntryDetail}
*/
export async function getTrendingEntryDetail(this: InstancedImport | AccessTokenObject | void, params: GetTrendingEntryDetailParams): Promise<BungieNetResponse<TrendingDetail>> {
