 ...
 * @see {@link https://bungie-net.github.io/#Trending.GetTrendingCategory}
*/
export async function getTrendingCategory(this:  AccessTokenObject | void, params: GetTrendingCategoryParams): Promise<BungieNetResponse<SearchResultOfTrendingEntry>> {
