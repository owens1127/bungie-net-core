 ...
 * @see {@link https://bungie-net.github.io/#App.GetApplicationApiUsage}
*/
export async function getApplicationApiUsage(this: InstancedImport | AccessTokenObject | void, params: GetApplicationApiUsageParams): Promise<BungieNetResponse<ApiUsage>> {
