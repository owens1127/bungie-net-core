...
export interface DestinyVendorItemComponentSet<K extends readonly DestinyComponentType[]> {
  readonly itemComponents: DictionaryComponentResponse<number, DestinyItemComponent, 'ItemCommonData', K>;
  readonly instances: DictionaryComponentResponse<number, DestinyItemInstanceComponent, 'ItemInstances', K>;
  readonly renderData: DictionaryComponentResponse<number, DestinyItemRenderComponent, 'ItemRenderData', K>;
  readonly stats: DictionaryComponentResponse<number, DestinyItemStatsComponent, 'ItemStats', K>;
  readonly sockets: DictionaryComponentResponse<number, DestinyItemSocketsComponent, 'ItemSockets', K>;
  ...
  readonly plugObjectives: DictionaryComponentResponse<
    ...
    K
  >;
  readonly talentGrids: DictionaryComponentResponse<number, DestinyItemTalentGridComponent, 'ItemTalentGrids', K>;
  readonly plugStates: DictionaryComponentResponse<number, DestinyItemPlugComponent, 'ItemPlugStates', K>;
  readonly objectives: DictionaryComponentResponse<number, DestinyItemObjectivesComponent, 'ItemObjectives', K>;
