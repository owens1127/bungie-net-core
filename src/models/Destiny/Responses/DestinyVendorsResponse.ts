...
import { DestinyVendorItemComponentSetOfint32 } from '../../DestinyVendorItemComponentSetOfint32';
...
export interface DestinyVendorsResponse<T extends readonly DestinyComponentType[]> {
   ...
   */
  readonly itemComponents: { [key: number]: DestinyVendorItemComponentSetOfint32<T> };
  /**
